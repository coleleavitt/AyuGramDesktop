...
#ifndef _GI_WEBVIEW_HELPERPROXY_IMPL_HPP_
#define _GI_WEBVIEW_HELPERPROXY_IMPL_HPP_
...
Webview::Helper HelperProxyBase::interface_ (gi::interface_tag<Webview::Helper>)
{ return gi::wrap ((Webview::Helper::BaseObjectType*) gobj_copy_(), gi::transfer_full); }

HelperProxyBase::operator Webview::Helper ()
...
gi::result<Webview::HelperProxy> base::HelperProxyBase::new_finish (Gio::AsyncResult res) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GAsyncResult* res, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_finish;
...
Webview::HelperProxy base::HelperProxyBase::new_finish (Gio::AsyncResult res, GLib::Error * _error) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GAsyncResult* res, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_finish;
  auto res_to_c = gi::unwrap (res, gi::transfer_none);
...
gi::result<Webview::HelperProxy> base::HelperProxyBase::new_for_bus_finish (Gio::AsyncResult res) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GAsyncResult* res, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_for_bus_finish;
  auto res_to_c = gi::unwrap (res, gi::transfer_none);
  GError *error = NULL;
  auto _temp_ret = call_wrap_v ((::GAsyncResult*) (res_to_c), &error);
  if (error) return gi::detail::make_unexpected (error);
...
Webview::HelperProxy base::HelperProxyBase::new_for_bus_finish (Gio::AsyncResult res, GLib::Error * _error) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GAsyncResult* res, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_for_bus_finish;
  auto res_to_c = gi::unwrap (res, gi::transfer_none);
...
gi::result<Webview::HelperProxy> base::HelperProxyBase::new_for_bus_sync (Gio::BusType bus_type, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::Cancellable cancellable) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GBusType bus_type, ::GDBusProxyFlags flags, const char* name, const char* object_path, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_for_bus_sync;
...
gi::result<Webview::HelperProxy> base::HelperProxyBase::new_for_bus_sync (Gio::BusType bus_type, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GBusType bus_type, ::GDBusProxyFlags flags, const char* name, const char* object_path, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_for_bus_sync;
...
Webview::HelperProxy base::HelperProxyBase::new_for_bus_sync (Gio::BusType bus_type, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::Cancellable cancellable, GLib::Error * _error) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GBusType bus_type, ::GDBusProxyFlags flags, const char* name, const char* object_path, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_for_bus_sync;
  auto cancellable_to_c = gi::unwrap (cancellable, gi::transfer_none);
...
Webview::HelperProxy base::HelperProxyBase::new_for_bus_sync (Gio::BusType bus_type, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, GLib::Error * _error) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GBusType bus_type, ::GDBusProxyFlags flags, const char* name, const char* object_path, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_for_bus_sync;
  auto cancellable_to_c = nullptr;
...
gi::result<Webview::HelperProxy> base::HelperProxyBase::new_sync (Gio::DBusConnection connection, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::Cancellable cancellable) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GDBusConnection* connection, ::GDBusProxyFlags flags, const char* name, const char* object_path, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_sync;
  auto cancellable_to_c = gi::unwrap (cancellable, gi::transfer_none);
  auto object_path_to_c = gi::unwrap (object_path, gi::transfer_none);
  auto name_to_c = gi::unwrap (name, gi::transfer_none);
  auto flags_to_c = gi::unwrap (flags);
...
gi::result<Webview::HelperProxy> base::HelperProxyBase::new_sync (Gio::DBusConnection connection, Gio::DBusProxyFlags flags, const gi::cstring_v object_path) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GDBusConnection* connection, ::GDBusProxyFlags flags, const char* name, const char* object_path, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_sync;
  auto cancellable_to_c = nullptr;
...
Webview::HelperProxy base::HelperProxyBase::new_sync (Gio::DBusConnection connection, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::Cancellable cancellable, GLib::Error * _error) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GDBusConnection* connection, ::GDBusProxyFlags flags, const char* name, const char* object_path, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_sync;
  auto cancellable_to_c = gi::unwrap (cancellable, gi::transfer_none);
...
Webview::HelperProxy base::HelperProxyBase::new_sync (Gio::DBusConnection connection, Gio::DBusProxyFlags flags, const gi::cstring_v object_path, GLib::Error * _error) noexcept
{
  typedef ::WebviewHelperProxy* (*call_wrap_t) (::GDBusConnection* connection, ::GDBusProxyFlags flags, const char* name, const char* object_path, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) webview_helper_proxy_new_sync;
  auto cancellable_to_c = nullptr;
...
void base::HelperProxyBase::new_ (Gio::DBusConnection connection, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback) noexcept
{
  ...
  call_wrap_t call_wrap_v = (call_wrap_t) ::webview_helper_proxy_new;
...
void base::HelperProxyBase::new_ (Gio::DBusConnection connection, Gio::DBusProxyFlags flags, const gi::cstring_v object_path, Gio::AsyncReadyCallback callback) noexcept
{
  typedef void (*call_wrap_t) (::GDBusConnection* connection, ::GDBusProxyFlags flags, const char* name, const char* object_path, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data);
  call_wrap_t call_wrap_v = (call_wrap_t) ::webview_helper_proxy_new;
  auto callback_wrap_ = callback ? unwrap (std::move (callback), gi::scope_async) : nullptr;
...
void base::HelperProxyBase::new_for_bus (Gio::BusType bus_type, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::Cancellable cancellable, Gio::AsyncReadyCallback callback) noexcept
{
  ...
  call_wrap_t call_wrap_v = (call_wrap_t) ::webview_helper_proxy_new_for_bus;
  auto callback_wrap_ = callback ? unwrap (std::move (callback), gi::scope_async) : nullptr;
  auto cancellable_to_c = gi::unwrap (cancellable, gi::transfer_none);
  auto object_path_to_c = gi::unwrap (object_path, gi::transfer_none);
  auto name_to_c = gi::unwrap (name, gi::transfer_none);
...
void base::HelperProxyBase::new_for_bus (Gio::BusType bus_type, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::AsyncReadyCallback callback) noexcept
{
  typedef void (*call_wrap_t) (::GBusType bus_type, ::GDBusProxyFlags flags, const char* name, const char* object_path, ::GCancellable* cancellable, Gio::AsyncReadyCallback::cfunction_type callback, void* user_data);
  call_wrap_t call_wrap_v = (call_wrap_t) ::webview_helper_proxy_new_for_bus;
  auto callback_wrap_ = callback ? unwrap (std::move (callback), gi::scope_async) : nullptr;
...
#if __has_include(<webview/helperproxy_extra_def_impl.hpp>)
#include <webview/helperproxy_extra_def_impl.hpp>
#endif
#endif


#if defined(__has_include)
#if __has_include(<webview/helperproxy_extra_impl.hpp>)
#include <webview/helperproxy_extra_impl.hpp>
#endif
#endif
...
void HelperProxyClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ::WebviewHelperProxyClass *methods = (::WebviewHelperProxyClass *) class_struct;
  (void) methods;
