...
#ifndef _GI_SNAPCRAFT_OBJECTMANAGERCLIENT_HPP_
#define _GI_SNAPCRAFT_OBJECTMANAGERCLIENT_HPP_
...
#define GI_SNAPCRAFT_OBJECTMANAGERCLIENT_BASE base::ObjectManagerClientBase
class ObjectManagerClientBase : public Gio::DBusObjectManagerClient
{
typedef Gio::DBusObjectManagerClient super_type;
public:
typedef ::SnapcraftObjectManagerClient BaseObjectType;
...
static GType get_type_ () G_GNUC_CONST { return snapcraft_object_manager_client_get_type(); } 
...
static GI_INLINE_DECL gi::result<Snapcraft::ObjectManagerClient> new_finish (Gio::AsyncResult res) noexcept;
static GI_INLINE_DECL Snapcraft::ObjectManagerClient new_finish (Gio::AsyncResult res, GLib::Error * _error) noexcept;
...
static GI_INLINE_DECL gi::result<Snapcraft::ObjectManagerClient> new_for_bus_finish (Gio::AsyncResult res) noexcept;
static GI_INLINE_DECL Snapcraft::ObjectManagerClient new_for_bus_finish (Gio::AsyncResult res, GLib::Error * _error) noexcept;
...
static GI_INLINE_DECL gi::result<Snapcraft::ObjectManagerClient> new_for_bus_sync (Gio::BusType bus_type, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::Cancellable cancellable) noexcept;
static GI_INLINE_DECL gi::result<Snapcraft::ObjectManagerClient> new_for_bus_sync (Gio::BusType bus_type, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path) noexcept;
static GI_INLINE_DECL Snapcraft::ObjectManagerClient new_for_bus_sync (Gio::BusType bus_type, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::Cancellable cancellable, GLib::Error * _error) noexcept;
static GI_INLINE_DECL Snapcraft::ObjectManagerClient new_for_bus_sync (Gio::BusType bus_type, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, GLib::Error * _error) noexcept;
...
static GI_INLINE_DECL gi::result<Snapcraft::ObjectManagerClient> new_sync (Gio::DBusConnection connection, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::Cancellable cancellable) noexcept;
static GI_INLINE_DECL gi::result<Snapcraft::ObjectManagerClient> new_sync (Gio::DBusConnection connection, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v object_path) noexcept;
static GI_INLINE_DECL Snapcraft::ObjectManagerClient new_sync (Gio::DBusConnection connection, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::Cancellable cancellable, GLib::Error * _error) noexcept;
static GI_INLINE_DECL Snapcraft::ObjectManagerClient new_sync (Gio::DBusConnection connection, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v object_path, GLib::Error * _error) noexcept;
...
#if __has_include(<snapcraft/objectmanagerclient_extra_def.hpp>)
#include <snapcraft/objectmanagerclient_extra_def.hpp>
#endif
#endif


#if defined(__has_include)
#if __has_include(<snapcraft/objectmanagerclient_extra.hpp>)
#include <snapcraft/objectmanagerclient_extra.hpp>
#endif
#endif
...
class ObjectManagerClient : public GI_SNAPCRAFT_OBJECTMANAGERCLIENT_BASE
{ typedef GI_SNAPCRAFT_OBJECTMANAGERCLIENT_BASE super_type; using super_type::super_type; };

} // namespace Snapcraft

template<> struct declare_cpptype_of<::SnapcraftObjectManagerClient>
{ typedef Snapcraft::ObjectManagerClient type; }; 
...
public:
typedef Snapcraft::ObjectManagerClient instance_type;
typedef ::SnapcraftObjectManagerClientClass class_type;
...
class ObjectManagerClientClass: public detail::ClassTemplate<Snapcraft::impl::internal::ObjectManagerClientClassDef, Gio::impl::internal::DBusObjectManagerClientClass>
{
friend class internal::ObjectManagerClientClassDef;
typedef ObjectManagerClientClass self;
typedef detail::ClassTemplate<Snapcraft::impl::internal::ObjectManagerClientClassDef, Gio::impl::internal::DBusObjectManagerClientClass> super;
