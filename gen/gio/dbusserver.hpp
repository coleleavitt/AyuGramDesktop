...
static GI_INLINE_DECL gi::result<Gio::DBusServer> new_sync (const gi::cstring_v address, Gio::DBusServerFlags flags, const gi::cstring_v guid, Gio::DBusAuthObserver observer, Gio::Cancellable cancellable) noexcept;
static GI_INLINE_DECL gi::result<Gio::DBusServer> new_sync (const gi::cstring_v address, Gio::DBusServerFlags flags, const gi::cstring_v guid) noexcept;
