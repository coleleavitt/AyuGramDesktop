...
// ::GInetAddressMask* /*full*/ g_inet_address_mask_new (::GInetAddress* addr /*none*/, guint length, GError ** error);
static GI_INLINE_DECL gi::result<Gio::InetAddressMask> new_ (Gio::InetAddress addr, guint length) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::InetAddressMask> new_from_string (const gi::cstring_v mask_string) noexcept;
