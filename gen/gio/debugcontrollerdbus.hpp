...
// ::GDebugControllerDBus* /*full,nullable*/ g_debug_controller_dbus_new (::GDBusConnection* connection /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
static GI_INLINE_DECL gi::result<Gio::DebugControllerDBus> new_ (Gio::DBusConnection connection, Gio::Cancellable cancellable) noexcept;
static GI_INLINE_DECL gi::result<Gio::DebugControllerDBus> new_ (Gio::DBusConnection connection) noexcept;
