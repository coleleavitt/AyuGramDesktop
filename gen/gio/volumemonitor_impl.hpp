...
void VolumeMonitorClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.drive_changed) methods->drive_changed = (decltype (methods->drive_changed)) gi::detail::method_wrapper<self, void (*) (Gio::Drive drive), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::drive_changed_>;
  if (init_data.drive_connected) methods->drive_connected = (decltype (methods->drive_connected)) gi::detail::method_wrapper<self, void (*) (Gio::Drive drive), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::drive_connected_>;
  if (init_data.drive_disconnected) methods->drive_disconnected = (decltype (methods->drive_disconnected)) gi::detail::method_wrapper<self, void (*) (Gio::Drive drive), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::drive_disconnected_>;
  if (init_data.drive_eject_button) methods->drive_eject_button = (decltype (methods->drive_eject_button)) gi::detail::method_wrapper<self, void (*) (Gio::Drive drive), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::drive_eject_button_>;
  if (init_data.drive_stop_button) methods->drive_stop_button = (decltype (methods->drive_stop_button)) gi::detail::method_wrapper<self, void (*) (Gio::Drive drive), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::drive_stop_button_>;
  if (init_data.get_connected_drives) methods->get_connected_drives = (decltype (methods->get_connected_drives)) gi::detail::method_wrapper<self, gi::Collection<GList, ::GDrive*, gi::transfer_full_t> (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_connected_drives_>;
  if (init_data.get_mount_for_uuid) methods->get_mount_for_uuid = (decltype (methods->get_mount_for_uuid)) gi::detail::method_wrapper<self, Gio::Mount (*) (const gi::cstring_v uuid), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_mount_for_uuid_>;
  if (init_data.get_mounts) methods->get_mounts = (decltype (methods->get_mounts)) gi::detail::method_wrapper<self, gi::Collection<GList, ::GMount*, gi::transfer_full_t> (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_mounts_>;
  if (init_data.get_volume_for_uuid) methods->get_volume_for_uuid = (decltype (methods->get_volume_for_uuid)) gi::detail::method_wrapper<self, Gio::Volume (*) (const gi::cstring_v uuid), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_volume_for_uuid_>;
  ...
  if (init_data.mount_added) methods->mount_added = (decltype (methods->mount_added)) gi::detail::method_wrapper<self, void (*) (Gio::Mount mount), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::mount_added_>;
  if (init_data.mount_changed) methods->mount_changed = (decltype (methods->mount_changed)) gi::detail::method_wrapper<self, void (*) (Gio::Mount mount), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::mount_changed_>;
  if (init_data.mount_pre_unmount) methods->mount_pre_unmount = (decltype (methods->mount_pre_unmount)) gi::detail::method_wrapper<self, void (*) (Gio::Mount mount), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::mount_pre_unmount_>;
  if (init_data.mount_removed) methods->mount_removed = (decltype (methods->mount_removed)) gi::detail::method_wrapper<self, void (*) (Gio::Mount mount), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::mount_removed_>;
  if (init_data.volume_added) methods->volume_added = (decltype (methods->volume_added)) gi::detail::method_wrapper<self, void (*) (Gio::Volume volume), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::volume_added_>;
  if (init_data.volume_changed) methods->volume_changed = (decltype (methods->volume_changed)) gi::detail::method_wrapper<self, void (*) (Gio::Volume volume), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::volume_changed_>;
  if (init_data.volume_removed) methods->volume_removed = (decltype (methods->volume_removed)) gi::detail::method_wrapper<self, void (*) (Gio::Volume volume), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::volume_removed_>;
}
