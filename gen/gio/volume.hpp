...
// gboolean g_volume_mount_finish (::GVolume* volume /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> mount_finish (Gio::AsyncResult result) noexcept;
...
struct VolumeIfaceDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(VolumeIfaceClassImpl, eject)
  GI_MEMBER_DEFINE(VolumeIfaceClassImpl, eject_finish)
