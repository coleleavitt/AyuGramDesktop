...
gi::result<Gio::DBusObjectManagerClient> base::DBusObjectManagerClientBase::new_finish (Gio::AsyncResult res) noexcept
{
...
gi::result<Gio::DBusObjectManagerClient> base::DBusObjectManagerClientBase::new_for_bus_finish (Gio::AsyncResult res) noexcept
{
  typedef ::GDBusObjectManagerClient* (*call_wrap_t) (::GAsyncResult* res, GError ** error);
...
gi::result<Gio::DBusObjectManagerClient> base::DBusObjectManagerClientBase::new_for_bus_sync (Gio::BusType bus_type, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::DBusProxyTypeFunc get_proxy_type_func, Gio::Cancellable cancellable) noexcept
{
...
gi::result<Gio::DBusObjectManagerClient> base::DBusObjectManagerClientBase::new_for_bus_sync (Gio::BusType bus_type, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::DBusProxyTypeFunc get_proxy_type_func) noexcept
{
  typedef ::GDBusObjectManagerClient* (*call_wrap_t) (::GBusType bus_type, ::GDBusObjectManagerClientFlags flags, const char* name, const char* object_path, Gio::DBusProxyTypeFunc::cfunction_type get_proxy_type_func, void* get_proxy_type_user_data, GLib::DestroyNotify::cfunction_type get_proxy_type_destroy_notify, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) g_dbus_object_manager_client_new_for_bus_sync;
...
gi::result<Gio::DBusObjectManagerClient> base::DBusObjectManagerClientBase::new_sync (Gio::DBusConnection connection, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::DBusProxyTypeFunc get_proxy_type_func, Gio::Cancellable cancellable) noexcept
{
...
gi::result<Gio::DBusObjectManagerClient> base::DBusObjectManagerClientBase::new_sync (Gio::DBusConnection connection, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v object_path, Gio::DBusProxyTypeFunc get_proxy_type_func) noexcept
{
  typedef ::GDBusObjectManagerClient* (*call_wrap_t) (::GDBusConnection* connection, ::GDBusObjectManagerClientFlags flags, const char* name, const char* object_path, Gio::DBusProxyTypeFunc::cfunction_type get_proxy_type_func, void* get_proxy_type_user_data, GLib::DestroyNotify::cfunction_type get_proxy_type_destroy_notify, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) g_dbus_object_manager_client_new_sync;
  auto cancellable_to_c = nullptr;
...
void DBusObjectManagerClientClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.interface_proxy_properties_changed && factory) methods->interface_proxy_properties_changed = (decltype (methods->interface_proxy_properties_changed)) gi::detail::method_wrapper<self, void (*) (::GDBusObjectProxy* object_proxy, ::GDBusProxy* interface_proxy, ::GVariant* changed_properties, const gchar* const* invalidated_properties), std::nullptr_t>::wrapper<&self::interface_proxy_properties_changed_>;
...
void DBusObjectManagerClientClass::interface_proxy_properties_changed_ (::GDBusObjectProxy* object_proxy, ::GDBusProxy* interface_proxy, ::GVariant* changed_properties, const gchar* const* invalidated_properties) noexcept
{
  if (!get_struct_()->interface_proxy_properties_changed) { g_critical ("no method in class struct"); return ; }
  typedef void (*call_wrap_t) (::GDBusObjectManagerClient*, ::GDBusObjectProxy*, ::GDBusProxy*, ::GVariant*, const gchar* const*);
  call_wrap_t call_wrap_v = (call_wrap_t) get_struct_()->interface_proxy_properties_changed;
  call_wrap_v (gobj_(), object_proxy, interface_proxy, changed_properties, invalidated_properties);
}
