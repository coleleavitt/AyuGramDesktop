...
gi::result<gssize> base::PollableInputStreamBase::read_nonblocking (guint8 * buffer, gsize count, Gio::Cancellable cancellable) noexcept
{
...
gi::result<gssize> base::PollableInputStreamBase::read_nonblocking (guint8 * buffer, gsize count) noexcept
{
  typedef gssize (*call_wrap_t) (::GPollableInputStream* stream, guint8* buffer, gsize count, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_pollable_input_stream_read_nonblocking;
  auto cancellable_to_c = nullptr;
