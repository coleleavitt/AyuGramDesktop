...
// ::GSocketConnection* /*full*/ g_socket_listener_accept (::GSocketListener* listener /*none*/, ::GObject** source_object /*none,out,opt,nullable*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::SocketConnection> accept (GObject::Object * source_object, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::SocketConnection> accept (GObject::Object * source_object) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<Gio::SocketConnection, GObject::Object>> accept (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<Gio::SocketConnection, GObject::Object>> accept () noexcept;
...
// ::GSocketConnection* /*full*/ g_socket_listener_accept_finish (::GSocketListener* listener /*none*/, ::GAsyncResult* result /*none*/, ::GObject** source_object /*none,out,opt,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::SocketConnection> accept_finish (Gio::AsyncResult result, GObject::Object * source_object) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<Gio::SocketConnection, GObject::Object>> accept_finish (Gio::AsyncResult result) noexcept;
...
// ::GSocket* /*full*/ g_socket_listener_accept_socket (::GSocketListener* listener /*none*/, ::GObject** source_object /*none,out,opt,nullable*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::Socket> accept_socket (GObject::Object * source_object, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::Socket> accept_socket (GObject::Object * source_object) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<Gio::Socket, GObject::Object>> accept_socket (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<Gio::Socket, GObject::Object>> accept_socket () noexcept;
...
// ::GSocket* /*full*/ g_socket_listener_accept_socket_finish (::GSocketListener* listener /*none*/, ::GAsyncResult* result /*none*/, ::GObject** source_object /*none,out,opt,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::Socket> accept_socket_finish (Gio::AsyncResult result, GObject::Object * source_object) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<Gio::Socket, GObject::Object>> accept_socket_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_socket_listener_add_address (::GSocketListener* listener /*none*/, ::GSocketAddress* address /*none*/, ::GSocketType type, ::GSocketProtocol protocol, ::GObject* source_object /*none,nullable*/, ::GSocketAddress** effective_address /*full,out,opt*/, GError ** error);
GI_INLINE_DECL gi::result<bool> add_address (Gio::SocketAddress address, Gio::SocketType type, Gio::SocketProtocol protocol, GObject::Object source_object, Gio::SocketAddress * effective_address) noexcept;
GI_INLINE_DECL gi::result<bool> add_address (Gio::SocketAddress address, Gio::SocketType type, Gio::SocketProtocol protocol, Gio::SocketAddress * effective_address) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, Gio::SocketAddress>> add_address (Gio::SocketAddress address, Gio::SocketType type, Gio::SocketProtocol protocol, GObject::Object source_object) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, Gio::SocketAddress>> add_address (Gio::SocketAddress address, Gio::SocketType type, Gio::SocketProtocol protocol) noexcept;
...
// guint16 g_socket_listener_add_any_inet_port (::GSocketListener* listener /*none*/, ::GObject* source_object /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<guint16> add_any_inet_port (GObject::Object source_object) noexcept;
GI_INLINE_DECL gi::result<guint16> add_any_inet_port () noexcept;
...
// gboolean g_socket_listener_add_inet_port (::GSocketListener* listener /*none*/, guint16 port, ::GObject* source_object /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> add_inet_port (guint16 port, GObject::Object source_object) noexcept;
GI_INLINE_DECL gi::result<bool> add_inet_port (guint16 port) noexcept;
...
// gboolean g_socket_listener_add_socket (::GSocketListener* listener /*none*/, ::GSocket* socket /*none*/, ::GObject* source_object /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> add_socket (Gio::Socket socket, GObject::Object source_object) noexcept;
GI_INLINE_DECL gi::result<bool> add_socket (Gio::Socket socket) noexcept;
