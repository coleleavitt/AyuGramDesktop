...
static GI_INLINE_DECL gi::result<Gio::TlsCertificate> new_from_file (const gi::cstring_v file) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::TlsCertificate> new_from_file_with_password (const gi::cstring_v file, const gi::cstring_v password) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::TlsCertificate> new_from_files (const gi::cstring_v cert_file, const gi::cstring_v key_file) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::TlsCertificate> new_from_pem (const gi::cstring_v data, gssize length) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::TlsCertificate> new_from_pkcs11_uris (const gi::cstring_v pkcs11_uri, const gi::cstring_v private_key_pkcs11_uri) noexcept;
static GI_INLINE_DECL gi::result<Gio::TlsCertificate> new_from_pkcs11_uris (const gi::cstring_v pkcs11_uri) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::TlsCertificate> new_from_pkcs12 (const guint8 * data, gsize length, const gi::cstring_v password) noexcept;
static GI_INLINE_DECL gi::result<Gio::TlsCertificate> new_from_pkcs12 (const guint8 * data, gsize length) noexcept;
...
static GI_INLINE_DECL gi::result<gi::Collection<GList, ::GTlsCertificate*, gi::transfer_full_t>> list_new_from_file (const gi::cstring_v file) noexcept;
