...
// ::GAppInfo* /*full*/ g_app_info_create_from_commandline (const char* commandline /*none*/, const char* application_name /*none,nullable*/, ::GAppInfoCreateFlags flags, GError ** error);
static GI_INLINE_DECL gi::result<Gio::AppInfo> create_from_commandline (const gi::cstring_v commandline, const gi::cstring_v application_name, Gio::AppInfoCreateFlags flags) noexcept;
static GI_INLINE_DECL gi::result<Gio::AppInfo> create_from_commandline (const gi::cstring_v commandline, Gio::AppInfoCreateFlags flags) noexcept;
...
// ::GAppInfo* /*full*/ g_app_info_get_default_for_type_finish (::GAsyncResult* result /*none*/, GError ** error);
static GI_INLINE_DECL gi::result<Gio::AppInfo> get_default_for_type_finish (Gio::AsyncResult result) noexcept;
...
// ::GAppInfo* /*full*/ g_app_info_get_default_for_uri_scheme_finish (::GAsyncResult* result /*none*/, GError ** error);
static GI_INLINE_DECL gi::result<Gio::AppInfo> get_default_for_uri_scheme_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_app_info_launch_default_for_uri (const char* uri /*none*/, ::GAppLaunchContext* context /*none,nullable*/, GError ** error);
static GI_INLINE_DECL gi::result<bool> launch_default_for_uri (const gi::cstring_v uri, Gio::AppLaunchContext context) noexcept;
static GI_INLINE_DECL gi::result<bool> launch_default_for_uri (const gi::cstring_v uri) noexcept;
...
// gboolean g_app_info_launch_default_for_uri_finish (::GAsyncResult* result /*none*/, GError ** error);
static GI_INLINE_DECL gi::result<bool> launch_default_for_uri_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_app_info_add_supports_type (::GAppInfo* appinfo /*none*/, const char* content_type /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> add_supports_type (const gi::cstring_v content_type) noexcept;
...
// gboolean g_app_info_launch (::GAppInfo* appinfo /*none*/, ::GList* files /*none,nullable*/, ::GAppLaunchContext* context /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> launch (gi::CollectionParameter<GList, ::GFile*, gi::transfer_none_t> files, Gio::AppLaunchContext context) noexcept;
GI_INLINE_DECL gi::result<bool> launch (gi::CollectionParameter<GList, ::GFile*, gi::transfer_none_t> files) noexcept;
...
// gboolean g_app_info_launch_uris (::GAppInfo* appinfo /*none*/, ::GList* uris /*none,nullable*/, ::GAppLaunchContext* context /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> launch_uris (gi::CollectionParameter<GList, char*, gi::transfer_none_t> uris, Gio::AppLaunchContext context) noexcept;
GI_INLINE_DECL gi::result<bool> launch_uris (gi::CollectionParameter<GList, char*, gi::transfer_none_t> uris) noexcept;
...
// gboolean g_app_info_launch_uris_finish (::GAppInfo* appinfo /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> launch_uris_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_app_info_remove_supports_type (::GAppInfo* appinfo /*none*/, const char* content_type /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> remove_supports_type (const gi::cstring_v content_type) noexcept;
...
// gboolean g_app_info_set_as_default_for_extension (::GAppInfo* appinfo /*none*/, const char* extension /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> set_as_default_for_extension (const gi::cstring_v extension) noexcept;
...
// gboolean g_app_info_set_as_default_for_type (::GAppInfo* appinfo /*none*/, const char* content_type /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> set_as_default_for_type (const gi::cstring_v content_type) noexcept;
...
// gboolean g_app_info_set_as_last_used_for_type (::GAppInfo* appinfo /*none*/, const char* content_type /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> set_as_last_used_for_type (const gi::cstring_v content_type) noexcept;
