...
static GI_INLINE_DECL gi::result<bool> parse_detailed_name (const gi::cstring_v detailed_name, gi::cstring * action_name, GLib::Variant * target_value) noexcept;
...
static GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring, GLib::Variant>> parse_detailed_name (const gi::cstring_v detailed_name) noexcept;
