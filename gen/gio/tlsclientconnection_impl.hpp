...
gi::result<Gio::TlsClientConnection> base::TlsClientConnectionBase::new_ (Gio::IOStream base_io_stream, Gio::SocketConnectable server_identity) noexcept
{
...
gi::result<Gio::TlsClientConnection> base::TlsClientConnectionBase::new_ (Gio::IOStream base_io_stream) noexcept
{
  typedef ::GTlsClientConnection* (*call_wrap_t) (::GIOStream* base_io_stream, ::GSocketConnectable* server_identity, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_tls_client_connection_new;
