...
// gssize g_buffered_input_stream_fill (::GBufferedInputStream* stream /*none*/, gssize count, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<gssize> fill (gssize count, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> fill (gssize count) noexcept;
...
// gssize g_buffered_input_stream_fill_finish (::GBufferedInputStream* stream /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gssize> fill_finish (Gio::AsyncResult result) noexcept;
...
GI_INLINE_DECL gi::result<gint> read_byte (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gint> read_byte () noexcept;
