...
// gboolean g_output_stream_close (::GOutputStream* stream /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> close (Gio::Cancellable cancellable) noexcept;
...
// gboolean g_output_stream_close_finish (::GOutputStream* stream /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> close_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_output_stream_flush (::GOutputStream* stream /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> flush (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> flush () noexcept;
...
// gboolean g_output_stream_flush_finish (::GOutputStream* stream /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> flush_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_output_stream_set_pending (::GOutputStream* stream /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> set_pending () noexcept;
...
// gssize g_output_stream_splice (::GOutputStream* stream /*none*/, ::GInputStream* source /*none*/, ::GOutputStreamSpliceFlags flags, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<gssize> splice (Gio::InputStream source, Gio::OutputStreamSpliceFlags flags, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> splice (Gio::InputStream source, Gio::OutputStreamSpliceFlags flags) noexcept;
...
// gssize g_output_stream_splice_finish (::GOutputStream* stream /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gssize> splice_finish (Gio::AsyncResult result) noexcept;
...
GI_INLINE_DECL gi::result<gssize> write (const guint8 * buffer, gsize count, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> write (const guint8 * buffer, gsize count) noexcept;
...
GI_INLINE_DECL gi::result<bool> write_all (const guint8 * buffer, gsize count, gsize * bytes_written, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> write_all (const guint8 * buffer, gsize count, gsize * bytes_written) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gsize>> write_all (const guint8 * buffer, gsize count, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gsize>> write_all (const guint8 * buffer, gsize count) noexcept;
...
// gboolean g_output_stream_write_all_finish (::GOutputStream* stream /*none*/, ::GAsyncResult* result /*none*/, gsize* bytes_written, GError ** error);
GI_INLINE_DECL gi::result<bool> write_all_finish (Gio::AsyncResult result, gsize * bytes_written) noexcept;
GI_INLINE_DECL bool write_all_finish (Gio::AsyncResult result, gsize * bytes_written, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gsize>> write_all_finish (Gio::AsyncResult result) noexcept;
...
// gssize g_output_stream_write_bytes (::GOutputStream* stream /*none*/, ::GBytes* bytes /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<gssize> write_bytes (GLib::Bytes_Ref bytes, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> write_bytes (GLib::Bytes_Ref bytes) noexcept;
...
// gssize g_output_stream_write_bytes_finish (::GOutputStream* stream /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gssize> write_bytes_finish (Gio::AsyncResult result) noexcept;
...
// gssize g_output_stream_write_finish (::GOutputStream* stream /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gssize> write_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_output_stream_writev_all_finish (::GOutputStream* stream /*none*/, ::GAsyncResult* result /*none*/, gsize* bytes_written, GError ** error);
GI_INLINE_DECL gi::result<bool> writev_all_finish (Gio::AsyncResult result, gsize * bytes_written) noexcept;
GI_INLINE_DECL bool writev_all_finish (Gio::AsyncResult result, gsize * bytes_written, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gsize>> writev_all_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_output_stream_writev_finish (::GOutputStream* stream /*none*/, ::GAsyncResult* result /*none*/, gsize* bytes_written, GError ** error);
GI_INLINE_DECL gi::result<bool> writev_finish (Gio::AsyncResult result, gsize * bytes_written) noexcept;
GI_INLINE_DECL bool writev_finish (Gio::AsyncResult result, gsize * bytes_written, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gsize>> writev_finish (Gio::AsyncResult result) noexcept;
...
using GI_MEMBER_CHECK_CONFLICT(writev_async) = self;
using GI_MEMBER_CHECK_CONFLICT(writev_finish) = self;
using GI_MEMBER_CHECK_CONFLICT(writev_fn) = self;
...
// SKIP; vectors in boxed array not supported (depth 1)
virtual void writev_async_ (const GOutputVector* vectors, gsize n_vectors, int io_priority, ::GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) noexcept = 0;
...
// gboolean OutputStream::writev_fn (::GOutputStream* stream /*none*/, const ::GOutputVector** vectors /*none*/, gsize n_vectors, gsize* bytes_written, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
// SKIP; vectors in boxed array not supported (depth 1)
virtual gboolean writev_fn_ (const GOutputVector* vectors, gsize n_vectors, gsize* bytes_written, ::GCancellable* cancellable, ::GError **error_) = 0;
...
// void OutputStream::writev_async (::GOutputStream* stream /*none*/, const ::GOutputVector** vectors /*none*/, gsize n_vectors, gint io_priority, ::GCancellable* cancellable /*none,nullable*/, Gio::AsyncReadyCallback::cfunction_type callback /*none,nullable*/, void* user_data);
// SKIP; vectors in boxed array not supported (depth 1)
GI_INLINE_DECL void writev_async_ (const GOutputVector* vectors, gsize n_vectors, int io_priority, ::GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) noexcept override;
...
// gboolean OutputStream::writev_fn (::GOutputStream* stream /*none*/, const ::GOutputVector** vectors /*none*/, gsize n_vectors, gsize* bytes_written, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
// SKIP; vectors in boxed array not supported (depth 1)
GI_INLINE_DECL gboolean writev_fn_ (const GOutputVector* vectors, gsize n_vectors, gsize* bytes_written, ::GCancellable* cancellable, ::GError **error_) override;
...
struct OutputStreamClassDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(OutputStreamClass, writev_async)
  GI_MEMBER_DEFINE(OutputStreamClass, writev_finish)
  GI_MEMBER_DEFINE(OutputStreamClass, writev_fn)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    ...
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, writev_async),
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, writev_finish),
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, writev_fn)
  };
}
};
} // namespace internal
