...
gi::result<Gio::DBusMessage> base::DBusMessageBase::new_from_blob (const guint8 * blob, gsize blob_len, Gio::DBusCapabilityFlags capabilities) noexcept
{
...
gi::result<gssize> base::DBusMessageBase::bytes_needed (const guint8 * blob, gsize blob_len) noexcept
{
...
// ::GDBusMessage* /*full*/ g_dbus_message_copy (::GDBusMessage* message /*none*/, GError ** error);
gi::result<Gio::DBusMessage> base::DBusMessageBase::copy () noexcept
{
...
gi::result<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>> base::DBusMessageBase::to_blob (Gio::DBusCapabilityFlags capabilities) noexcept
{
...
// gboolean g_dbus_message_to_gerror (::GDBusMessage* message /*none*/, GError ** error);
gi::result<bool> base::DBusMessageBase::to_gerror () noexcept
{
