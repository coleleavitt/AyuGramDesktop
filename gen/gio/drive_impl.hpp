...
// gboolean g_drive_eject_with_operation_finish (::GDrive* drive /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
gi::result<bool> base::DriveBase::eject_with_operation_finish (Gio::AsyncResult result) noexcept
{
...
// gboolean g_drive_poll_for_media_finish (::GDrive* drive /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
gi::result<bool> base::DriveBase::poll_for_media_finish (Gio::AsyncResult result) noexcept
{
  typedef gboolean (*call_wrap_t) (::GDrive* drive, ::GAsyncResult* result, GError ** error);
...
// gboolean g_drive_start_finish (::GDrive* drive /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
gi::result<bool> base::DriveBase::start_finish (Gio::AsyncResult result) noexcept
{
  typedef gboolean (*call_wrap_t) (::GDrive* drive, ::GAsyncResult* result, GError ** error);
...
// gboolean g_drive_stop_finish (::GDrive* drive /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
gi::result<bool> base::DriveBase::stop_finish (Gio::AsyncResult result) noexcept
{
  typedef gboolean (*call_wrap_t) (::GDrive* drive, ::GAsyncResult* result, GError ** error);
...
// IGNORE; deprecated
void DriveIfaceClassImpl::eject_ (::GMountUnmountFlags flags, ::GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) noexcept
{
  if (!get_struct_()->eject) { g_critical ("no method in class struct"); return ; }
  typedef void (*call_wrap_t) (::GDrive*, ::GMountUnmountFlags, ::GCancellable*, GAsyncReadyCallback, gpointer);
...
// gboolean Drive::eject_finish (::GDrive* drive /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
// IGNORE; deprecated
gboolean DriveIfaceClassImpl::eject_finish_ (::GAsyncResult* result, ::GError **error_)
{
  if (!get_struct_()->eject_finish) { g_critical ("no method in class struct"); return {}; }
  typedef gboolean (*call_wrap_t) (::GDrive*, ::GAsyncResult*, ::GError **error_);
