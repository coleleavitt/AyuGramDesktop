...
// ::GInetAddressMask* /*full*/ g_inet_address_mask_new (::GInetAddress* addr /*none*/, guint length, GError ** error);
gi::result<Gio::InetAddressMask> base::InetAddressMaskBase::new_ (Gio::InetAddress addr, guint length) noexcept
{
...
gi::result<Gio::InetAddressMask> base::InetAddressMaskBase::new_from_string (const gi::cstring_v mask_string) noexcept
{
