...
static GI_INLINE_DECL gi::result<Gio::DBusObjectManagerClient> new_finish (Gio::AsyncResult res) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::DBusObjectManagerClient> new_for_bus_finish (Gio::AsyncResult res) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::DBusObjectManagerClient> new_for_bus_sync (Gio::BusType bus_type, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::DBusProxyTypeFunc get_proxy_type_func, Gio::Cancellable cancellable) noexcept;
static GI_INLINE_DECL gi::result<Gio::DBusObjectManagerClient> new_for_bus_sync (Gio::BusType bus_type, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::DBusProxyTypeFunc get_proxy_type_func) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::DBusObjectManagerClient> new_sync (Gio::DBusConnection connection, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, Gio::DBusProxyTypeFunc get_proxy_type_func, Gio::Cancellable cancellable) noexcept;
static GI_INLINE_DECL gi::result<Gio::DBusObjectManagerClient> new_sync (Gio::DBusConnection connection, Gio::DBusObjectManagerClientFlags flags, const gi::cstring_v object_path, Gio::DBusProxyTypeFunc get_proxy_type_func) noexcept;
...
using GI_MEMBER_CHECK_CONFLICT(interface_proxy_properties_changed) = self;
...
virtual void interface_proxy_properties_changed_ (::GDBusObjectProxy* object_proxy, ::GDBusProxy* interface_proxy, ::GVariant* changed_properties, const gchar* const* invalidated_properties) noexcept = 0;
...
// void DBusObjectManagerClient::interface_proxy_properties_changed (::GDBusObjectManagerClient* manager /*none*/, ::GDBusObjectProxy* object_proxy /*none*/, ::GDBusProxy* interface_proxy /*none*/, ::GVariant* changed_properties /*none*/, const char* invalidated_properties /*none*/);
// SKIP; inconsistent invalidated_properties in pointer depth (2 vs 1)
GI_INLINE_DECL void interface_proxy_properties_changed_ (::GDBusObjectProxy* object_proxy, ::GDBusProxy* interface_proxy, ::GVariant* changed_properties, const gchar* const* invalidated_properties) noexcept override;
...
{
  GI_MEMBER_DEFINE(DBusObjectManagerClientClass, interface_proxy_properties_changed)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, interface_proxy_properties_changed),
