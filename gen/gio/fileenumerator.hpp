...
// gboolean g_file_enumerator_iterate (::GFileEnumerator* direnum /*none*/, ::GFileInfo** out_info /*none,out,opt*/, ::GFile** out_child /*none,out,opt*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> iterate (Gio::FileInfo * out_info, Gio::File * out_child, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> iterate (Gio::FileInfo * out_info, Gio::File * out_child) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, Gio::FileInfo, Gio::File>> iterate (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, Gio::FileInfo, Gio::File>> iterate () noexcept;
...
// ::GFileInfo* /*full,nullable*/ g_file_enumerator_next_file (::GFileEnumerator* enumerator /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::FileInfo> next_file (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::FileInfo> next_file () noexcept;
...
// ::GList* /*full*/ g_file_enumerator_next_files_finish (::GFileEnumerator* enumerator /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GFileInfo*, gi::transfer_full_t>> next_files_finish (Gio::AsyncResult result) noexcept;
