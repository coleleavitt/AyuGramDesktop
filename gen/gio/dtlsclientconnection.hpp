...
static GI_INLINE_DECL gi::result<Gio::DtlsClientConnection> new_ (Gio::DatagramBased base_socket, Gio::SocketConnectable server_identity) noexcept;
static GI_INLINE_DECL gi::result<Gio::DtlsClientConnection> new_ (Gio::DatagramBased base_socket) noexcept;
