...
void SocketServiceClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.incoming) methods->incoming = (decltype (methods->incoming)) gi::detail::method_wrapper<self, bool (*) (Gio::SocketConnection connection, GObject::Object source_object), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::incoming_>;
}
