...
// ::GDBusProxy* /*full*/ g_dbus_proxy_new_finish (::GAsyncResult* res /*none*/, GError ** error);
static GI_INLINE_DECL gi::result<Gio::DBusProxy> new_finish (Gio::AsyncResult res) noexcept;
...
// ::GDBusProxy* /*full*/ g_dbus_proxy_new_for_bus_finish (::GAsyncResult* res /*none*/, GError ** error);
static GI_INLINE_DECL gi::result<Gio::DBusProxy> new_for_bus_finish (Gio::AsyncResult res) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::DBusProxy> new_for_bus_sync (Gio::BusType bus_type, Gio::DBusProxyFlags flags, Gio::DBusInterfaceInfo_Ref info, const gi::cstring_v name, const gi::cstring_v object_path, const gi::cstring_v interface_name, Gio::Cancellable cancellable) noexcept;
static GI_INLINE_DECL gi::result<Gio::DBusProxy> new_for_bus_sync (Gio::BusType bus_type, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, const gi::cstring_v interface_name) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::DBusProxy> new_sync (Gio::DBusConnection connection, Gio::DBusProxyFlags flags, Gio::DBusInterfaceInfo_Ref info, const gi::cstring_v name, const gi::cstring_v object_path, const gi::cstring_v interface_name, Gio::Cancellable cancellable) noexcept;
static GI_INLINE_DECL gi::result<Gio::DBusProxy> new_sync (Gio::DBusConnection connection, Gio::DBusProxyFlags flags, const gi::cstring_v object_path, const gi::cstring_v interface_name) noexcept;
...
GI_INLINE_DECL gi::result<GLib::Variant> call_sync (const gi::cstring_v method_name, GLib::Variant parameters, Gio::DBusCallFlags flags, gint timeout_msec, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<GLib::Variant> call_sync (const gi::cstring_v method_name, Gio::DBusCallFlags flags, gint timeout_msec) noexcept;
...
GI_INLINE_DECL gi::result<GLib::Variant> call_with_unix_fd_list_sync (const gi::cstring_v method_name, GLib::Variant parameters, Gio::DBusCallFlags flags, gint timeout_msec, Gio::UnixFDList fd_list, Gio::UnixFDList * out_fd_list, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<GLib::Variant> call_with_unix_fd_list_sync (const gi::cstring_v method_name, Gio::DBusCallFlags flags, gint timeout_msec, Gio::UnixFDList * out_fd_list) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<GLib::Variant, Gio::UnixFDList>> call_with_unix_fd_list_sync (const gi::cstring_v method_name, GLib::Variant parameters, Gio::DBusCallFlags flags, gint timeout_msec, Gio::UnixFDList fd_list, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<GLib::Variant, Gio::UnixFDList>> call_with_unix_fd_list_sync (const gi::cstring_v method_name, Gio::DBusCallFlags flags, gint timeout_msec) noexcept;
...
using GI_MEMBER_CHECK_CONFLICT(g_properties_changed) = self;
...
virtual void g_properties_changed_ (::GVariant* changed_properties, const gchar* const* invalidated_properties) noexcept = 0;
...
// void DBusProxy::g_properties_changed (::GDBusProxy* proxy /*none*/, ::GVariant* changed_properties /*none*/, const char* invalidated_properties /*none*/);
// SKIP; inconsistent invalidated_properties in pointer depth (2 vs 1)
GI_INLINE_DECL void g_properties_changed_ (::GVariant* changed_properties, const gchar* const* invalidated_properties) noexcept override;
...
{
  GI_MEMBER_DEFINE(DBusProxyClass, g_properties_changed)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, g_properties_changed),
