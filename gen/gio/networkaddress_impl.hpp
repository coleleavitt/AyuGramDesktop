...
gi::result<Gio::NetworkAddress> base::NetworkAddressBase::parse (const gi::cstring_v host_and_port, guint16 default_port) noexcept
{
...
gi::result<Gio::NetworkAddress> base::NetworkAddressBase::parse_uri (const gi::cstring_v uri, guint16 default_port) noexcept
{
