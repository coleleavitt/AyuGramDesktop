...
gi::result<Gio::TlsServerConnection> base::TlsServerConnectionBase::new_ (Gio::IOStream base_io_stream, Gio::TlsCertificate certificate) noexcept
{
...
gi::result<Gio::TlsServerConnection> base::TlsServerConnectionBase::new_ (Gio::IOStream base_io_stream) noexcept
{
  typedef ::GTlsServerConnection* (*call_wrap_t) (::GIOStream* base_io_stream, ::GTlsCertificate* certificate, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_tls_server_connection_new;
