...
using GI_MEMBER_CHECK_CONFLICT(set_value) = self;
...
virtual const guchar* get_value_ (gsize* length) noexcept = 0;
...
// SKIP; callback misses closure info
virtual void set_value_ (guchar* value, gssize length, GDestroyNotify destroy) noexcept = 0;
...
// const guint8* /*none*/ TlsPassword::get_value (::GTlsPassword* password /*none*/, gsize* length);
// SKIP; virtual-method return array not supported
GI_INLINE_DECL const guchar* get_value_ (gsize* length) noexcept override;

// void TlsPassword::set_value (GTlsPassword* password /*none*/, guchar* value /*none*/, gssize length, GDestroyNotify destroy /*none,nullable*/);
// void TlsPassword::set_value (::GTlsPassword* password /*none*/, guint8* value /*none*/, gssize length, GLib::DestroyNotify::cfunction_type destroy /*none,nullable*/);
// SKIP; callback misses closure info
GI_INLINE_DECL void set_value_ (guchar* value, gssize length, GDestroyNotify destroy) noexcept override;
...
struct TlsPasswordClassDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(TlsPasswordClass, get_value)
  GI_MEMBER_DEFINE(TlsPasswordClass, set_value)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    ...
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, set_value)
  };
}
};
} // namespace internal
