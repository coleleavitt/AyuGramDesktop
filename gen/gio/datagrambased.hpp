...
// gboolean g_datagram_based_condition_wait (::GDatagramBased* datagram_based /*none*/, ::GIOCondition condition, gint64 timeout, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> condition_wait (GLib::IOCondition condition, gint64 timeout, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> condition_wait (GLib::IOCondition condition, gint64 timeout) noexcept;
...
using GI_MEMBER_CHECK_CONFLICT(receive_messages) = self;
using GI_MEMBER_CHECK_CONFLICT(send_messages) = self;
...
// gint DatagramBased::receive_messages (::GDatagramBased* datagram_based /*none*/, ::GInputMessage** messages /*none*/, guint num_messages, gint flags, gint64 timeout, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
// SKIP; messages in boxed array not supported (depth 1)
virtual gint receive_messages_ (::GInputMessage* messages, guint num_messages, gint flags, gint64 timeout, ::GCancellable* cancellable, ::GError **error_) = 0;
...
// gint DatagramBased::send_messages (::GDatagramBased* datagram_based /*none*/, ::GOutputMessage** messages /*none*/, guint num_messages, gint flags, gint64 timeout, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
// SKIP; messages in boxed array not supported (depth 1)
virtual gint send_messages_ (::GOutputMessage* messages, guint num_messages, gint flags, gint64 timeout, ::GCancellable* cancellable, ::GError **error_) = 0;
...
// gint DatagramBased::receive_messages (::GDatagramBased* datagram_based /*none*/, ::GInputMessage** messages /*none*/, guint num_messages, gint flags, gint64 timeout, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
// SKIP; messages in boxed array not supported (depth 1)
GI_INLINE_DECL gint receive_messages_ (::GInputMessage* messages, guint num_messages, gint flags, gint64 timeout, ::GCancellable* cancellable, ::GError **error_) override;

// gint DatagramBased::send_messages (GDatagramBased* datagram_based /*none*/, GOutputMessage* messages /*none*/, guint num_messages, gint flags, gint64 timeout, GCancellable* cancellable /*none,nullable*/, GError ** error);
// gint DatagramBased::send_messages (::GDatagramBased* datagram_based /*none*/, ::GOutputMessage** messages /*none*/, guint num_messages, gint flags, gint64 timeout, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
// SKIP; messages in boxed array not supported (depth 1)
GI_INLINE_DECL gint send_messages_ (::GOutputMessage* messages, guint num_messages, gint flags, gint64 timeout, ::GCancellable* cancellable, ::GError **error_) override;
...
struct DatagramBasedInterfaceDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(DatagramBasedInterfaceClassImpl, receive_messages)
  GI_MEMBER_DEFINE(DatagramBasedInterfaceClassImpl, send_messages)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    ...
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, receive_messages),
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, send_messages)
  };
}
};
} // namespace internal
