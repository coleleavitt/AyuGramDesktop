...
GI_INLINE_DECL gi::result<gpointer> propagate_pointer () noexcept;
...
// gboolean g_task_propagate_value (::GTask* task /*none*/, ::GValue* value /*none,out,ca*/, GError ** error);
GI_INLINE_DECL gi::result<bool> propagate_value (GObject::Value & value) noexcept;
GI_INLINE_DECL bool propagate_value (GObject::Value & value, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, GObject::Value>> propagate_value () noexcept;
