...
static GI_INLINE_DECL gi::result<Gio::SettingsSchemaSource> new_from_directory (const gi::cstring_v directory, Gio::SettingsSchemaSource_Ref parent, gboolean trusted) noexcept;
static GI_INLINE_DECL gi::result<Gio::SettingsSchemaSource> new_from_directory (const gi::cstring_v directory, gboolean trusted) noexcept;
