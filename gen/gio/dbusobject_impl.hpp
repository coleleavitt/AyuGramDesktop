...
void DBusObjectIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.get_interface) methods->get_interface = (decltype (methods->get_interface)) gi::detail::method_wrapper<self, Gio::DBusInterface (*) (const gi::cstring_v interface_name), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_interface_>;
  if (init_data.get_interfaces) methods->get_interfaces = (decltype (methods->get_interfaces)) gi::detail::method_wrapper<self, gi::Collection<GList, ::GDBusInterface*, gi::transfer_full_t> (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_interfaces_>;
  ...
  if (init_data.interface_added) methods->interface_added = (decltype (methods->interface_added)) gi::detail::method_wrapper<self, void (*) (Gio::DBusInterface interface_), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::interface_added_>;
  if (init_data.interface_removed) methods->interface_removed = (decltype (methods->interface_removed)) gi::detail::method_wrapper<self, void (*) (Gio::DBusInterface interface_), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::interface_removed_>;
}
