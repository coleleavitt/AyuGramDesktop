...
GI_INLINE_DECL gi::result<bool> put_byte (guint8 data, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> put_byte (guint8 data) noexcept;
...
// gboolean g_data_output_stream_put_int16 (::GDataOutputStream* stream /*none*/, gint16 data, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> put_int16 (gint16 data, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> put_int16 (gint16 data) noexcept;
...
// gboolean g_data_output_stream_put_int32 (::GDataOutputStream* stream /*none*/, gint32 data, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> put_int32 (gint32 data, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> put_int32 (gint32 data) noexcept;
...
// gboolean g_data_output_stream_put_int64 (::GDataOutputStream* stream /*none*/, gint64 data, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> put_int64 (gint64 data, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> put_int64 (gint64 data) noexcept;
...
// gboolean g_data_output_stream_put_string (::GDataOutputStream* stream /*none*/, const char* str /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> put_string (const gi::cstring_v str, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> put_string (const gi::cstring_v str) noexcept;
...
// gboolean g_data_output_stream_put_uint16 (::GDataOutputStream* stream /*none*/, guint16 data, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> put_uint16 (guint16 data, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> put_uint16 (guint16 data) noexcept;
...
// gboolean g_data_output_stream_put_uint32 (::GDataOutputStream* stream /*none*/, guint32 data, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> put_uint32 (guint32 data, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> put_uint32 (guint32 data) noexcept;
...
// gboolean g_data_output_stream_put_uint64 (::GDataOutputStream* stream /*none*/, guint64 data, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> put_uint64 (guint64 data, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> put_uint64 (guint64 data) noexcept;
