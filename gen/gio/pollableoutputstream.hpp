...
GI_INLINE_DECL gi::result<gssize> write_nonblocking (const guint8 * buffer, gsize count, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> write_nonblocking (const guint8 * buffer, gsize count) noexcept;
...
using GI_MEMBER_CHECK_CONFLICT(writev_nonblocking) = self;
...
// ::GPollableReturn PollableOutputStream::writev_nonblocking (::GPollableOutputStream* stream /*none*/, const ::GOutputVector** vectors /*none*/, gsize n_vectors, gsize* bytes_written, GError ** error);
// SKIP; vectors in boxed array not supported (depth 1)
virtual ::GPollableReturn writev_nonblocking_ (const GOutputVector* vectors, gsize n_vectors, gsize* bytes_written, ::GError **error_) = 0;
...
// ::GPollableReturn PollableOutputStream::writev_nonblocking (::GPollableOutputStream* stream /*none*/, const ::GOutputVector** vectors /*none*/, gsize n_vectors, gsize* bytes_written, GError ** error);
// SKIP; vectors in boxed array not supported (depth 1)
GI_INLINE_DECL ::GPollableReturn writev_nonblocking_ (const GOutputVector* vectors, gsize n_vectors, gsize* bytes_written, ::GError **error_) override;
...
struct PollableOutputStreamInterfaceDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(PollableOutputStreamInterfaceClassImpl, writev_nonblocking)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    ...
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, writev_nonblocking)
  };
}
};
} // namespace internal
