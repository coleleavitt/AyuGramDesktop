...
// ::GIOStream* /*full*/ g_proxy_connect (::GProxy* proxy /*none*/, ::GIOStream* connection /*none*/, ::GProxyAddress* proxy_address /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::IOStream> connect (Gio::IOStream connection, Gio::ProxyAddress proxy_address, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::IOStream> connect (Gio::IOStream connection, Gio::ProxyAddress proxy_address) noexcept;
...
// ::GIOStream* /*full*/ g_proxy_connect_finish (::GProxy* proxy /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::IOStream> connect_finish (Gio::AsyncResult result) noexcept;
