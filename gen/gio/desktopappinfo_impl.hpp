...
gi::result<bool> base::DesktopAppInfoBase::launch_uris_as_manager (gi::CollectionParameter<GList, char*, gi::transfer_none_t> uris, Gio::AppLaunchContext launch_context, GLib::SpawnFlags spawn_flags, GLib::SpawnChildSetupFunc user_setup, Gio::DesktopAppLaunchCallback pid_callback) noexcept
{
...
gi::result<bool> base::DesktopAppInfoBase::launch_uris_as_manager (gi::CollectionParameter<GList, char*, gi::transfer_none_t> uris, GLib::SpawnFlags spawn_flags, GLib::SpawnChildSetupFunc user_setup, Gio::DesktopAppLaunchCallback pid_callback) noexcept
{
  typedef gboolean (*call_wrap_t) (::GDesktopAppInfo* appinfo, ::GList* uris, ::GAppLaunchContext* launch_context, ::GSpawnFlags spawn_flags, GLib::SpawnChildSetupFunc::cfunction_type user_setup, void* user_setup_data, Gio::DesktopAppLaunchCallback::cfunction_type pid_callback, void* pid_callback_data, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_desktop_app_info_launch_uris_as_manager;
  auto pid_callback_wrap_ = pid_callback ? unwrap (std::move (pid_callback), gi::scope_call) : nullptr;
...
gi::result<bool> base::DesktopAppInfoBase::launch_uris_as_manager_with_fds (gi::CollectionParameter<GList, char*, gi::transfer_none_t> uris, Gio::AppLaunchContext launch_context, GLib::SpawnFlags spawn_flags, GLib::SpawnChildSetupFunc user_setup, Gio::DesktopAppLaunchCallback pid_callback, gint stdin_fd, gint stdout_fd, gint stderr_fd) noexcept
{
...
gi::result<bool> base::DesktopAppInfoBase::launch_uris_as_manager_with_fds (gi::CollectionParameter<GList, char*, gi::transfer_none_t> uris, GLib::SpawnFlags spawn_flags, GLib::SpawnChildSetupFunc user_setup, Gio::DesktopAppLaunchCallback pid_callback, gint stdin_fd, gint stdout_fd, gint stderr_fd) noexcept
{
  typedef gboolean (*call_wrap_t) (::GDesktopAppInfo* appinfo, ::GList* uris, ::GAppLaunchContext* launch_context, ::GSpawnFlags spawn_flags, GLib::SpawnChildSetupFunc::cfunction_type user_setup, void* user_setup_data, Gio::DesktopAppLaunchCallback::cfunction_type pid_callback, void* pid_callback_data, gint stdin_fd, gint stdout_fd, gint stderr_fd, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_desktop_app_info_launch_uris_as_manager_with_fds;
  auto stderr_fd_to_c = stderr_fd;
