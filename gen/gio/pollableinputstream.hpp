...
GI_INLINE_DECL gi::result<gssize> read_nonblocking (guint8 * buffer, gsize count, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> read_nonblocking (guint8 * buffer, gsize count) noexcept;
