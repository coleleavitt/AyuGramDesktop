...
GI_INLINE_DECL gi::result<bool> launch_uris_as_manager (gi::CollectionParameter<GList, char*, gi::transfer_none_t> uris, Gio::AppLaunchContext launch_context, GLib::SpawnFlags spawn_flags, GLib::SpawnChildSetupFunc user_setup, Gio::DesktopAppLaunchCallback pid_callback) noexcept;
GI_INLINE_DECL gi::result<bool> launch_uris_as_manager (gi::CollectionParameter<GList, char*, gi::transfer_none_t> uris, GLib::SpawnFlags spawn_flags, GLib::SpawnChildSetupFunc user_setup, Gio::DesktopAppLaunchCallback pid_callback) noexcept;
...
GI_INLINE_DECL gi::result<bool> launch_uris_as_manager_with_fds (gi::CollectionParameter<GList, char*, gi::transfer_none_t> uris, GLib::SpawnFlags spawn_flags, GLib::SpawnChildSetupFunc user_setup, Gio::DesktopAppLaunchCallback pid_callback, gint stdin_fd, gint stdout_fd, gint stderr_fd) noexcept;
