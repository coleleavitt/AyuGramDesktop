...
gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> base::ProxyResolverBase::lookup (const gi::cstring_v uri, Gio::Cancellable cancellable) noexcept
{
...
gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> base::ProxyResolverBase::lookup (const gi::cstring_v uri) noexcept
{
  typedef char** (*call_wrap_t) (::GProxyResolver* resolver, const char* uri, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_proxy_resolver_lookup;
...
gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> base::ProxyResolverBase::lookup_finish (Gio::AsyncResult result) noexcept
{
