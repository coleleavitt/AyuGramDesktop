...
gi::result<bool> base::SeekableBase::seek (gint64 offset, GLib::SeekType type, Gio::Cancellable cancellable) noexcept
{
...
gi::result<bool> base::SeekableBase::seek (gint64 offset, GLib::SeekType type) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSeekable* seekable, gint64 offset, ::GSeekType type, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_seekable_seek;
...
gi::result<bool> base::SeekableBase::truncate (gint64 offset, Gio::Cancellable cancellable) noexcept
{
...
gi::result<bool> base::SeekableBase::truncate (gint64 offset) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSeekable* seekable, gint64 offset, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_seekable_truncate;
  auto cancellable_to_c = nullptr;
