...
gi::result<Gio::DtlsClientConnection> base::DtlsClientConnectionBase::new_ (Gio::DatagramBased base_socket, Gio::SocketConnectable server_identity) noexcept
{
...
gi::result<Gio::DtlsClientConnection> base::DtlsClientConnectionBase::new_ (Gio::DatagramBased base_socket) noexcept
{
  typedef ::GDtlsClientConnection* (*call_wrap_t) (::GDatagramBased* base_socket, ::GSocketConnectable* server_identity, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dtls_client_connection_new;
