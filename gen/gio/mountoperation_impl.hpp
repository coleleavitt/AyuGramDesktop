...
void MountOperationClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.ask_question && factory) methods->ask_question = (decltype (methods->ask_question)) gi::detail::method_wrapper<self, void (*) (const char* message, const char** choices), std::nullptr_t>::wrapper<&self::ask_question_>;
  ...
  if (init_data.show_processes && factory) methods->show_processes = (decltype (methods->show_processes)) gi::detail::method_wrapper<self, void (*) (const gchar* message, GArray* processes, const gchar** choices), std::nullptr_t>::wrapper<&self::show_processes_>;
...
void MountOperationClass::ask_question_ (const char* message, const char** choices) noexcept
{
  if (!get_struct_()->ask_question) { g_critical ("no method in class struct"); return ; }
  typedef void (*call_wrap_t) (::GMountOperation*, const char*, const char**);
  call_wrap_t call_wrap_v = (call_wrap_t) get_struct_()->ask_question;
  call_wrap_v (gobj_(), message, choices);
}
...
void MountOperationClass::show_processes_ (const gchar* message, GArray* processes, const gchar** choices) noexcept
{
  if (!get_struct_()->show_processes) { g_critical ("no method in class struct"); return ; }
  typedef void (*call_wrap_t) (::GMountOperation*, const gchar*, GArray*, const gchar**);
  call_wrap_t call_wrap_v = (call_wrap_t) get_struct_()->show_processes;
  call_wrap_v (gobj_(), message, processes, choices);
}
