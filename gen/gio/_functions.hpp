...
// ::GDBusConnection* /*full*/ g_bus_get_finish (::GAsyncResult* res /*none*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::DBusConnection> bus_get_finish (Gio::AsyncResult res) noexcept;
...
// ::GDBusConnection* /*full*/ g_bus_get_sync (::GBusType bus_type, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::DBusConnection> bus_get_sync (Gio::BusType bus_type, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::DBusConnection> bus_get_sync (Gio::BusType bus_type) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> dbus_address_get_for_bus_sync (Gio::BusType bus_type, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gi::cstring> dbus_address_get_for_bus_sync (Gio::BusType bus_type) noexcept;
...
GI_INLINE_DECL gi::result<Gio::IOStream> dbus_address_get_stream_finish (Gio::AsyncResult res, gi::cstring * out_guid) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<Gio::IOStream, gi::cstring>> dbus_address_get_stream_finish (Gio::AsyncResult res) noexcept;
...
GI_INLINE_DECL gi::result<Gio::IOStream> dbus_address_get_stream_sync (const gi::cstring_v address, gi::cstring * out_guid, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::IOStream> dbus_address_get_stream_sync (const gi::cstring_v address, gi::cstring * out_guid) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<Gio::IOStream, gi::cstring>> dbus_address_get_stream_sync (const gi::cstring_v address, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<Gio::IOStream, gi::cstring>> dbus_address_get_stream_sync (const gi::cstring_v address) noexcept;
...
GI_INLINE_DECL gi::result<bool> dbus_is_supported_address (const gi::cstring_v string) noexcept;
...
GI_INLINE_DECL gi::result<gssize> pollable_stream_read (Gio::InputStream stream, const guint8 * buffer, gsize count, gboolean blocking, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> pollable_stream_read (Gio::InputStream stream, const guint8 * buffer, gsize count, gboolean blocking) noexcept;
...
GI_INLINE_DECL gi::result<gssize> pollable_stream_write (Gio::OutputStream stream, const guint8 * buffer, gsize count, gboolean blocking, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> pollable_stream_write (Gio::OutputStream stream, const guint8 * buffer, gsize count, gboolean blocking) noexcept;
...
GI_INLINE_DECL gi::result<bool> pollable_stream_write_all (Gio::OutputStream stream, const guint8 * buffer, gsize count, gboolean blocking, gsize & bytes_written, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> pollable_stream_write_all (Gio::OutputStream stream, const guint8 * buffer, gsize count, gboolean blocking, gsize & bytes_written) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gsize>> pollable_stream_write_all (Gio::OutputStream stream, const guint8 * buffer, gsize count, gboolean blocking, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gsize>> pollable_stream_write_all (Gio::OutputStream stream, const guint8 * buffer, gsize count, gboolean blocking) noexcept;
...
// char** /*full*/ g_resources_enumerate_children (const char* path /*none*/, ::GResourceLookupFlags lookup_flags, GError ** error);
GI_INLINE_DECL gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> resources_enumerate_children (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept;
...
// gboolean g_resources_get_info (const char* path /*none*/, ::GResourceLookupFlags lookup_flags, gsize* size, guint32* flags, GError ** error);
GI_INLINE_DECL gi::result<bool> resources_get_info (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags, gsize * size, guint32 * flags) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gsize, guint32>> resources_get_info (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept;
...
// ::GBytes* /*full*/ g_resources_lookup_data (const char* path /*none*/, ::GResourceLookupFlags lookup_flags, GError ** error);
GI_INLINE_DECL gi::result<GLib::Bytes> resources_lookup_data (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept;
...
// ::GInputStream* /*full*/ g_resources_open_stream (const char* path /*none*/, ::GResourceLookupFlags lookup_flags, GError ** error);
GI_INLINE_DECL gi::result<Gio::InputStream> resources_open_stream (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept;
...
// gboolean g_unix_mount_entries_changed_since (guint64 time);
GI_INLINE_DECL bool unix_mount_entries_changed_since (guint64 time) noexcept;

// GList* /*full*/ g_unix_mount_entries_get (guint64* time_read);
// ::GList* /*full*/ g_unix_mount_entries_get (guint64* time_read);
GI_INLINE_DECL gi::Collection<GList, ::GUnixMountEntry*, gi::transfer_full_t> unix_mount_entries_get (guint64 * time_read) noexcept;
GI_INLINE_DECL std::tuple<gi::Collection<GList, ::GUnixMountEntry*, gi::transfer_full_t>, guint64> unix_mount_entries_get () noexcept;

// GUnixMountEntry** /*full,nullable*/ g_unix_mount_entries_get_from_file (const char* table_path /*none*/, uint64_t* time_read_out, size_t* n_entries_out);
// ::GUnixMountEntry** /*full,nullable*/ g_unix_mount_entries_get_from_file (const char* table_path /*none*/, guint64 time_read_out, gsize* n_entries_out);
// SKIP; inconsistent time_read_out out pointer depth (1 vs 0)
...
// GUnixMountPoint** /*full,nullable*/ g_unix_mount_points_get_from_file (const char* table_path /*none*/, uint64_t* time_read_out, size_t* n_points_out);
// ::GUnixMountPoint** /*full,nullable*/ g_unix_mount_points_get_from_file (const char* table_path /*none*/, guint64 time_read_out, gsize* n_points_out);
// SKIP; inconsistent time_read_out out pointer depth (1 vs 0)
