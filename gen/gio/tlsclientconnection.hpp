...
static GI_INLINE_DECL gi::result<Gio::TlsClientConnection> new_ (Gio::IOStream base_io_stream, Gio::SocketConnectable server_identity) noexcept;
static GI_INLINE_DECL gi::result<Gio::TlsClientConnection> new_ (Gio::IOStream base_io_stream) noexcept;
