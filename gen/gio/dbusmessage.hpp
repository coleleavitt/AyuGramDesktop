...
static GI_INLINE_DECL gi::result<Gio::DBusMessage> new_from_blob (const guint8 * blob, gsize blob_len, Gio::DBusCapabilityFlags capabilities) noexcept;
...
static GI_INLINE_DECL gi::result<gssize> bytes_needed (const guint8 * blob, gsize blob_len) noexcept;
...
// ::GDBusMessage* /*full*/ g_dbus_message_copy (::GDBusMessage* message /*none*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::DBusMessage> copy () noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>> to_blob (Gio::DBusCapabilityFlags capabilities) noexcept;
...
// gboolean g_dbus_message_to_gerror (::GDBusMessage* message /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> to_gerror () noexcept;
