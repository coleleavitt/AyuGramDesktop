...
void MemoryMonitorInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.low_memory_warning) methods->low_memory_warning = (decltype (methods->low_memory_warning)) gi::detail::method_wrapper<self, void (*) (Gio::MemoryMonitorWarningLevel level), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::low_memory_warning_>;
}
