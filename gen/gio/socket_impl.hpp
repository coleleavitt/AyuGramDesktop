...
// ::GSocket* /*full*/ g_socket_new (::GSocketFamily family, ::GSocketType type, ::GSocketProtocol protocol, GError ** error);
gi::result<Gio::Socket> base::SocketBase::new_ (Gio::SocketFamily family, Gio::SocketType type, Gio::SocketProtocol protocol) noexcept
{
...
// ::GSocket* /*full*/ g_socket_new_from_fd (gint fd, GError ** error);
gi::result<Gio::Socket> base::SocketBase::new_from_fd (gint fd) noexcept
{
...
// ::GSocket* /*full*/ g_socket_accept (::GSocket* socket /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
gi::result<Gio::Socket> base::SocketBase::accept (Gio::Cancellable cancellable) noexcept
{
...
gi::result<Gio::Socket> base::SocketBase::accept () noexcept
{
  typedef ::GSocket* (*call_wrap_t) (::GSocket* socket, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_accept;
...
// gboolean g_socket_bind (::GSocket* socket /*none*/, ::GSocketAddress* address /*none*/, gboolean allow_reuse, GError ** error);
gi::result<bool> base::SocketBase::bind (Gio::SocketAddress address, gboolean allow_reuse) noexcept
{
...
// gboolean g_socket_check_connect_result (::GSocket* socket /*none*/, GError ** error);
gi::result<bool> base::SocketBase::check_connect_result () noexcept
{
...
// gboolean g_socket_close (::GSocket* socket /*none*/, GError ** error);
gi::result<bool> base::SocketBase::close () noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, GError ** error);
...
// gboolean g_socket_condition_timed_wait (::GSocket* socket /*none*/, ::GIOCondition condition, gint64 timeout_us, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
gi::result<bool> base::SocketBase::condition_timed_wait (GLib::IOCondition condition, gint64 timeout_us, Gio::Cancellable cancellable) noexcept
{
...
gi::result<bool> base::SocketBase::condition_timed_wait (GLib::IOCondition condition, gint64 timeout_us) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, ::GIOCondition condition, gint64 timeout_us, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_condition_timed_wait;
  auto cancellable_to_c = nullptr;
...
// gboolean g_socket_condition_wait (::GSocket* socket /*none*/, ::GIOCondition condition, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
gi::result<bool> base::SocketBase::condition_wait (GLib::IOCondition condition, Gio::Cancellable cancellable) noexcept
{
...
gi::result<bool> base::SocketBase::condition_wait (GLib::IOCondition condition) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, ::GIOCondition condition, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_condition_wait;
  auto cancellable_to_c = nullptr;
...
// gboolean g_socket_connect (::GSocket* socket /*none*/, ::GSocketAddress* address /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
gi::result<bool> base::SocketBase::connect (Gio::SocketAddress address, Gio::Cancellable cancellable) noexcept
{
...
gi::result<bool> base::SocketBase::connect (Gio::SocketAddress address) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, ::GSocketAddress* address, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_connect;
  auto cancellable_to_c = nullptr;
...
// ::GCredentials* /*full*/ g_socket_get_credentials (::GSocket* socket /*none*/, GError ** error);
gi::result<Gio::Credentials> base::SocketBase::get_credentials () noexcept
{
...
// ::GSocketAddress* /*full*/ g_socket_get_local_address (::GSocket* socket /*none*/, GError ** error);
gi::result<Gio::SocketAddress> base::SocketBase::get_local_address () noexcept
{
...
// gboolean g_socket_get_option (::GSocket* socket /*none*/, gint level, gint optname, gint* value, GError ** error);
gi::result<bool> base::SocketBase::get_option (gint level, gint optname, gint & value) noexcept
{
...
gi::result<std::tuple<bool, gint>> base::SocketBase::get_option (gint level, gint optname) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, gint level, gint optname, gint* value, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_get_option;
  gint value_o {};
...
// ::GSocketAddress* /*full*/ g_socket_get_remote_address (::GSocket* socket /*none*/, GError ** error);
gi::result<Gio::SocketAddress> base::SocketBase::get_remote_address () noexcept
{
  typedef ::GSocketAddress* (*call_wrap_t) (::GSocket* socket, GError ** error);
...
gi::result<bool> base::SocketBase::join_multicast_group (Gio::InetAddress group, gboolean source_specific, const gi::cstring_v iface) noexcept
{
...
gi::result<bool> base::SocketBase::join_multicast_group (Gio::InetAddress group, gboolean source_specific) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, ::GInetAddress* group, gboolean source_specific, const char* iface, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_join_multicast_group;
...
gi::result<bool> base::SocketBase::join_multicast_group_ssm (Gio::InetAddress group, Gio::InetAddress source_specific, const gi::cstring_v iface) noexcept
{
...
gi::result<bool> base::SocketBase::join_multicast_group_ssm (Gio::InetAddress group) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, ::GInetAddress* group, ::GInetAddress* source_specific, const char* iface, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_join_multicast_group_ssm;
  auto iface_to_c = nullptr;
...
gi::result<bool> base::SocketBase::leave_multicast_group (Gio::InetAddress group, gboolean source_specific, const gi::cstring_v iface) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, ::GInetAddress* group, gboolean source_specific, const char* iface, GError ** error);
...
gi::result<bool> base::SocketBase::leave_multicast_group (Gio::InetAddress group, gboolean source_specific) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, ::GInetAddress* group, gboolean source_specific, const char* iface, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_leave_multicast_group;
  auto iface_to_c = nullptr;
...
gi::result<bool> base::SocketBase::leave_multicast_group_ssm (Gio::InetAddress group, Gio::InetAddress source_specific, const gi::cstring_v iface) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, ::GInetAddress* group, ::GInetAddress* source_specific, const char* iface, GError ** error);
...
gi::result<bool> base::SocketBase::leave_multicast_group_ssm (Gio::InetAddress group) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, ::GInetAddress* group, ::GInetAddress* source_specific, const char* iface, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_leave_multicast_group_ssm;
  auto iface_to_c = nullptr;
...
// gboolean g_socket_listen (::GSocket* socket /*none*/, GError ** error);
gi::result<bool> base::SocketBase::listen () noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, GError ** error);
...
gi::result<gssize> base::SocketBase::receive (guint8 * buffer, gsize size, Gio::Cancellable cancellable) noexcept
{
...
gi::result<gssize> base::SocketBase::receive (guint8 * buffer, gsize size) noexcept
{
  typedef gssize (*call_wrap_t) (::GSocket* socket, guint8* buffer, gsize size, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_receive;
  auto cancellable_to_c = nullptr;
...
// ::GBytes* /*full*/ g_socket_receive_bytes (::GSocket* socket /*none*/, gsize size, gint64 timeout_us, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
gi::result<GLib::Bytes> base::SocketBase::receive_bytes (gsize size, gint64 timeout_us, Gio::Cancellable cancellable) noexcept
{
...
gi::result<GLib::Bytes> base::SocketBase::receive_bytes (gsize size, gint64 timeout_us) noexcept
{
  typedef ::GBytes* (*call_wrap_t) (::GSocket* socket, gsize size, gint64 timeout_us, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_receive_bytes;
  auto cancellable_to_c = nullptr;
...
// ::GBytes* /*full*/ g_socket_receive_bytes_from (::GSocket* socket /*none*/, ::GSocketAddress** address /*full,out,opt*/, gsize size, gint64 timeout_us, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
gi::result<GLib::Bytes> base::SocketBase::receive_bytes_from (Gio::SocketAddress * address, gsize size, gint64 timeout_us, Gio::Cancellable cancellable) noexcept
{
...
gi::result<GLib::Bytes> base::SocketBase::receive_bytes_from (Gio::SocketAddress * address, gsize size, gint64 timeout_us) noexcept
{
  typedef ::GBytes* (*call_wrap_t) (::GSocket* socket, ::GSocketAddress** address, gsize size, gint64 timeout_us, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_receive_bytes_from;
  auto cancellable_to_c = nullptr;
...
gi::result<std::tuple<GLib::Bytes, Gio::SocketAddress>> base::SocketBase::receive_bytes_from (gsize size, gint64 timeout_us, Gio::Cancellable cancellable) noexcept
{
  typedef ::GBytes* (*call_wrap_t) (::GSocket* socket, ::GSocketAddress** address, gsize size, gint64 timeout_us, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_receive_bytes_from;
  auto cancellable_to_c = gi::unwrap (cancellable, gi::transfer_none);
...
gi::result<std::tuple<GLib::Bytes, Gio::SocketAddress>> base::SocketBase::receive_bytes_from (gsize size, gint64 timeout_us) noexcept
{
  typedef ::GBytes* (*call_wrap_t) (::GSocket* socket, ::GSocketAddress** address, gsize size, gint64 timeout_us, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_receive_bytes_from;
  auto cancellable_to_c = nullptr;
...
gi::result<gssize> base::SocketBase::receive_from (Gio::SocketAddress * address, guint8 * buffer, gsize size, Gio::Cancellable cancellable) noexcept
{
...
gi::result<gssize> base::SocketBase::receive_from (Gio::SocketAddress * address, guint8 * buffer, gsize size) noexcept
{
  typedef gssize (*call_wrap_t) (::GSocket* socket, ::GSocketAddress** address, guint8* buffer, gsize size, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_receive_from;
  auto cancellable_to_c = nullptr;
...
gi::result<std::tuple<gssize, Gio::SocketAddress>> base::SocketBase::receive_from (guint8 * buffer, gsize size, Gio::Cancellable cancellable) noexcept
{
  typedef gssize (*call_wrap_t) (::GSocket* socket, ::GSocketAddress** address, guint8* buffer, gsize size, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_receive_from;
  auto cancellable_to_c = gi::unwrap (cancellable, gi::transfer_none);
...
gi::result<std::tuple<gssize, Gio::SocketAddress>> base::SocketBase::receive_from (guint8 * buffer, gsize size) noexcept
{
  typedef gssize (*call_wrap_t) (::GSocket* socket, ::GSocketAddress** address, guint8* buffer, gsize size, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_receive_from;
  auto cancellable_to_c = nullptr;
...
gi::result<gssize> base::SocketBase::receive_with_blocking (guint8 * buffer, gsize size, gboolean blocking, Gio::Cancellable cancellable) noexcept
{
...
gi::result<gssize> base::SocketBase::receive_with_blocking (guint8 * buffer, gsize size, gboolean blocking) noexcept
{
  typedef gssize (*call_wrap_t) (::GSocket* socket, guint8* buffer, gsize size, gboolean blocking, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_receive_with_blocking;
  auto cancellable_to_c = nullptr;
...
gi::result<gssize> base::SocketBase::send (const guint8 * buffer, gsize size, Gio::Cancellable cancellable) noexcept
{
...
gi::result<gssize> base::SocketBase::send (const guint8 * buffer, gsize size) noexcept
{
  typedef gssize (*call_wrap_t) (::GSocket* socket, const guint8* buffer, gsize size, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_send;
  auto cancellable_to_c = nullptr;
...
gi::result<gssize> base::SocketBase::send_to (Gio::SocketAddress address, const guint8 * buffer, gsize size, Gio::Cancellable cancellable) noexcept
{
...
gi::result<gssize> base::SocketBase::send_to (const guint8 * buffer, gsize size) noexcept
{
  typedef gssize (*call_wrap_t) (::GSocket* socket, ::GSocketAddress* address, const guint8* buffer, gsize size, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_send_to;
  auto cancellable_to_c = nullptr;
...
gi::result<gssize> base::SocketBase::send_with_blocking (const guint8 * buffer, gsize size, gboolean blocking, Gio::Cancellable cancellable) noexcept
{
...
gi::result<gssize> base::SocketBase::send_with_blocking (const guint8 * buffer, gsize size, gboolean blocking) noexcept
{
  typedef gssize (*call_wrap_t) (::GSocket* socket, const guint8* buffer, gsize size, gboolean blocking, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_socket_send_with_blocking;
  auto cancellable_to_c = nullptr;
...
// gboolean g_socket_set_option (::GSocket* socket /*none*/, gint level, gint optname, gint value, GError ** error);
gi::result<bool> base::SocketBase::set_option (gint level, gint optname, gint value) noexcept
{
  typedef gboolean (*call_wrap_t) (::GSocket* socket, gint level, gint optname, gint value, GError ** error);
...
// gboolean g_socket_shutdown (::GSocket* socket /*none*/, gboolean shutdown_read, gboolean shutdown_write, GError ** error);
gi::result<bool> base::SocketBase::shutdown (gboolean shutdown_read, gboolean shutdown_write) noexcept
{
