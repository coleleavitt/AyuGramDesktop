...
GI_INLINE_DECL gi::result<Gio::TlsCertificate> lookup_certificate_for_handle (const gi::cstring_v handle, Gio::TlsInteraction interaction, Gio::TlsDatabaseLookupFlags flags, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::TlsCertificate> lookup_certificate_for_handle (const gi::cstring_v handle, Gio::TlsDatabaseLookupFlags flags) noexcept;
...
// ::GTlsCertificate* /*full*/ g_tls_database_lookup_certificate_for_handle_finish (::GTlsDatabase* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::TlsCertificate> lookup_certificate_for_handle_finish (Gio::AsyncResult result) noexcept;
...
// ::GTlsCertificate* /*full*/ g_tls_database_lookup_certificate_issuer (::GTlsDatabase* self /*none*/, ::GTlsCertificate* certificate /*none*/, ::GTlsInteraction* interaction /*none,nullable*/, ::GTlsDatabaseLookupFlags flags, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::TlsCertificate> lookup_certificate_issuer (Gio::TlsCertificate certificate, Gio::TlsInteraction interaction, Gio::TlsDatabaseLookupFlags flags, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::TlsCertificate> lookup_certificate_issuer (Gio::TlsCertificate certificate, Gio::TlsDatabaseLookupFlags flags) noexcept;
...
// ::GTlsCertificate* /*full*/ g_tls_database_lookup_certificate_issuer_finish (::GTlsDatabase* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::TlsCertificate> lookup_certificate_issuer_finish (Gio::AsyncResult result) noexcept;
...
// ::GList* /*full*/ g_tls_database_lookup_certificates_issued_by (::GTlsDatabase* self /*none*/, ::GByteArray* issuer_raw_dn /*none*/, ::GTlsInteraction* interaction /*none,nullable*/, ::GTlsDatabaseLookupFlags flags, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GTlsCertificate*, gi::transfer_full_t>> lookup_certificates_issued_by (GLib::ByteArray_Ref issuer_raw_dn, Gio::TlsInteraction interaction, Gio::TlsDatabaseLookupFlags flags, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GTlsCertificate*, gi::transfer_full_t>> lookup_certificates_issued_by (GLib::ByteArray_Ref issuer_raw_dn, Gio::TlsDatabaseLookupFlags flags) noexcept;
...
// ::GList* /*full*/ g_tls_database_lookup_certificates_issued_by_finish (::GTlsDatabase* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GTlsCertificate*, gi::transfer_full_t>> lookup_certificates_issued_by_finish (Gio::AsyncResult result) noexcept;
...
GI_INLINE_DECL gi::result<Gio::TlsCertificateFlags> verify_chain (Gio::TlsCertificate chain, const gi::cstring_v purpose, Gio::SocketConnectable identity, Gio::TlsInteraction interaction, Gio::TlsDatabaseVerifyFlags flags, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::TlsCertificateFlags> verify_chain (Gio::TlsCertificate chain, const gi::cstring_v purpose, Gio::TlsDatabaseVerifyFlags flags) noexcept;
...
// ::GTlsCertificateFlags g_tls_database_verify_chain_finish (::GTlsDatabase* self /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::TlsCertificateFlags> verify_chain_finish (Gio::AsyncResult result) noexcept;
