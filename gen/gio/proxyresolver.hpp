...
GI_INLINE_DECL gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> lookup (const gi::cstring_v uri, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> lookup (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> lookup_finish (Gio::AsyncResult result) noexcept;
