...
// ::GSocket* /*full*/ g_socket_new (::GSocketFamily family, ::GSocketType type, ::GSocketProtocol protocol, GError ** error);
static GI_INLINE_DECL gi::result<Gio::Socket> new_ (Gio::SocketFamily family, Gio::SocketType type, Gio::SocketProtocol protocol) noexcept;
...
// ::GSocket* /*full*/ g_socket_new_from_fd (gint fd, GError ** error);
static GI_INLINE_DECL gi::result<Gio::Socket> new_from_fd (gint fd) noexcept;
...
// ::GSocket* /*full*/ g_socket_accept (::GSocket* socket /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::Socket> accept (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::Socket> accept () noexcept;
...
// gboolean g_socket_bind (::GSocket* socket /*none*/, ::GSocketAddress* address /*none*/, gboolean allow_reuse, GError ** error);
GI_INLINE_DECL gi::result<bool> bind (Gio::SocketAddress address, gboolean allow_reuse) noexcept;
...
// gboolean g_socket_check_connect_result (::GSocket* socket /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> check_connect_result () noexcept;
...
// gboolean g_socket_close (::GSocket* socket /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> close () noexcept;
...
// gboolean g_socket_condition_timed_wait (::GSocket* socket /*none*/, ::GIOCondition condition, gint64 timeout_us, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> condition_timed_wait (GLib::IOCondition condition, gint64 timeout_us, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> condition_timed_wait (GLib::IOCondition condition, gint64 timeout_us) noexcept;
...
// gboolean g_socket_condition_wait (::GSocket* socket /*none*/, ::GIOCondition condition, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> condition_wait (GLib::IOCondition condition, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> condition_wait (GLib::IOCondition condition) noexcept;
...
// gboolean g_socket_connect (::GSocket* socket /*none*/, ::GSocketAddress* address /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> connect (Gio::SocketAddress address, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> connect (Gio::SocketAddress address) noexcept;
...
// ::GCredentials* /*full*/ g_socket_get_credentials (::GSocket* socket /*none*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::Credentials> get_credentials () noexcept;
...
// ::GSocketAddress* /*full*/ g_socket_get_local_address (::GSocket* socket /*none*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::SocketAddress> get_local_address () noexcept;
...
// gboolean g_socket_get_option (::GSocket* socket /*none*/, gint level, gint optname, gint* value, GError ** error);
GI_INLINE_DECL gi::result<bool> get_option (gint level, gint optname, gint & value) noexcept;
GI_INLINE_DECL bool get_option (gint level, gint optname, gint & value, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gint>> get_option (gint level, gint optname) noexcept;
...
// ::GSocketAddress* /*full*/ g_socket_get_remote_address (::GSocket* socket /*none*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::SocketAddress> get_remote_address () noexcept;
...
GI_INLINE_DECL gi::result<bool> join_multicast_group (Gio::InetAddress group, gboolean source_specific, const gi::cstring_v iface) noexcept;
GI_INLINE_DECL gi::result<bool> join_multicast_group (Gio::InetAddress group, gboolean source_specific) noexcept;
...
GI_INLINE_DECL gi::result<bool> join_multicast_group_ssm (Gio::InetAddress group, Gio::InetAddress source_specific, const gi::cstring_v iface) noexcept;
GI_INLINE_DECL gi::result<bool> join_multicast_group_ssm (Gio::InetAddress group) noexcept;
...
GI_INLINE_DECL gi::result<bool> leave_multicast_group (Gio::InetAddress group, gboolean source_specific, const gi::cstring_v iface) noexcept;
GI_INLINE_DECL gi::result<bool> leave_multicast_group (Gio::InetAddress group, gboolean source_specific) noexcept;
...
GI_INLINE_DECL gi::result<bool> leave_multicast_group_ssm (Gio::InetAddress group, Gio::InetAddress source_specific, const gi::cstring_v iface) noexcept;
GI_INLINE_DECL gi::result<bool> leave_multicast_group_ssm (Gio::InetAddress group) noexcept;
...
// gboolean g_socket_listen (::GSocket* socket /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> listen () noexcept;
...
GI_INLINE_DECL gi::result<gssize> receive (guint8 * buffer, gsize size, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> receive (guint8 * buffer, gsize size) noexcept;
...
// ::GBytes* /*full*/ g_socket_receive_bytes (::GSocket* socket /*none*/, gsize size, gint64 timeout_us, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::Bytes> receive_bytes (gsize size, gint64 timeout_us, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<GLib::Bytes> receive_bytes (gsize size, gint64 timeout_us) noexcept;
...
// ::GBytes* /*full*/ g_socket_receive_bytes_from (::GSocket* socket /*none*/, ::GSocketAddress** address /*full,out,opt*/, gsize size, gint64 timeout_us, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::Bytes> receive_bytes_from (Gio::SocketAddress * address, gsize size, gint64 timeout_us, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<GLib::Bytes> receive_bytes_from (Gio::SocketAddress * address, gsize size, gint64 timeout_us) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<GLib::Bytes, Gio::SocketAddress>> receive_bytes_from (gsize size, gint64 timeout_us, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<GLib::Bytes, Gio::SocketAddress>> receive_bytes_from (gsize size, gint64 timeout_us) noexcept;
...
GI_INLINE_DECL gi::result<gssize> receive_from (Gio::SocketAddress * address, guint8 * buffer, gsize size, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> receive_from (Gio::SocketAddress * address, guint8 * buffer, gsize size) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<gssize, Gio::SocketAddress>> receive_from (guint8 * buffer, gsize size, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<gssize, Gio::SocketAddress>> receive_from (guint8 * buffer, gsize size) noexcept;
...
GI_INLINE_DECL gi::result<gssize> receive_with_blocking (guint8 * buffer, gsize size, gboolean blocking, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> receive_with_blocking (guint8 * buffer, gsize size, gboolean blocking) noexcept;
...
GI_INLINE_DECL gi::result<gssize> send (const guint8 * buffer, gsize size, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> send (const guint8 * buffer, gsize size) noexcept;
...
GI_INLINE_DECL gi::result<gssize> send_to (Gio::SocketAddress address, const guint8 * buffer, gsize size, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> send_to (const guint8 * buffer, gsize size) noexcept;
...
GI_INLINE_DECL gi::result<gssize> send_with_blocking (const guint8 * buffer, gsize size, gboolean blocking, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> send_with_blocking (const guint8 * buffer, gsize size, gboolean blocking) noexcept;
...
// gboolean g_socket_set_option (::GSocket* socket /*none*/, gint level, gint optname, gint value, GError ** error);
GI_INLINE_DECL gi::result<bool> set_option (gint level, gint optname, gint value) noexcept;
...
// gboolean g_socket_shutdown (::GSocket* socket /*none*/, gboolean shutdown_read, gboolean shutdown_write, GError ** error);
GI_INLINE_DECL gi::result<bool> shutdown (gboolean shutdown_read, gboolean shutdown_write) noexcept;
