...
static GI_INLINE_DECL gi::result<Gio::DtlsServerConnection> new_ (Gio::DatagramBased base_socket, Gio::TlsCertificate certificate) noexcept;
static GI_INLINE_DECL gi::result<Gio::DtlsServerConnection> new_ (Gio::DatagramBased base_socket) noexcept;
