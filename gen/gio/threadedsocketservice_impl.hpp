...
void ThreadedSocketServiceClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.run) methods->run = (decltype (methods->run)) gi::detail::method_wrapper<self, bool (*) (Gio::SocketConnection connection, GObject::Object source_object), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::run_>;
}
