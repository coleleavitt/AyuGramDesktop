...
gi::result<Gio::ConverterResult> base::ConverterBase::convert (const guint8 * inbuf, gsize inbuf_size, const guint8 * outbuf, gsize outbuf_size, Gio::ConverterFlags flags, gsize & bytes_read, gsize & bytes_written) noexcept
{
...
gi::result<std::tuple<Gio::ConverterResult, gsize, gsize>> base::ConverterBase::convert (const guint8 * inbuf, gsize inbuf_size, const guint8 * outbuf, gsize outbuf_size, Gio::ConverterFlags flags) noexcept
{
  typedef ::GConverterResult (*call_wrap_t) (::GConverter* converter, guint8* inbuf, gsize inbuf_size, guint8* outbuf, gsize outbuf_size, ::GConverterFlags flags, gsize* bytes_read, gsize* bytes_written, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_converter_convert;
  gsize bytes_written_o {};
...
// ::GBytes* /*full*/ g_converter_convert_bytes (::GConverter* converter /*none*/, ::GBytes* bytes /*none*/, GError ** error);
gi::result<GLib::Bytes> base::ConverterBase::convert_bytes (GLib::Bytes_Ref bytes) noexcept
{
