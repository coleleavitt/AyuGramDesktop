...
using GI_MEMBER_CHECK_CONFLICT(ask_question) = self;
using GI_MEMBER_CHECK_CONFLICT(reply) = self;
using GI_MEMBER_CHECK_CONFLICT(show_processes) = self;
...
virtual void ask_question_ (const char* message, const char** choices) noexcept = 0;
...
// SKIP; processes type  not supported
virtual void show_processes_ (const gchar* message, GArray* processes, const gchar** choices) noexcept = 0;
...
// void MountOperation::ask_question (::GMountOperation* op /*none*/, const char* message /*none*/, const char** choices /*none*/);
// IGNORE; marked ignore
GI_INLINE_DECL void ask_question_ (const char* message, const char** choices) noexcept override;
...
// void MountOperation::show_processes (::GMountOperation* op /*none*/, const char* message /*none*/,  processes /*none*/, const char** choices /*none*/);
// SKIP; processes type  not supported
GI_INLINE_DECL void show_processes_ (const gchar* message, GArray* processes, const gchar** choices) noexcept override;
...
struct MountOperationClassDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(MountOperationClass, ask_question)
  GI_MEMBER_DEFINE(MountOperationClass, reply)
  GI_MEMBER_DEFINE(MountOperationClass, show_processes)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    ...
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, ask_question),
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, reply),
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, show_processes),
