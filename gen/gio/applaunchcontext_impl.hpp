...
// char* /*full,nullable*/ g_app_launch_context_get_startup_notify_id (GAppLaunchContext* context /*none*/, GAppInfo* info /*none,nullable*/, GList* files /*none,nullable*/);
// char* /*full,nullable*/ g_app_launch_context_get_startup_notify_id (::GAppLaunchContext* context /*none*/, ::GAppInfo* info /*none,nullable*/, ::GList* files /*none,nullable*/);
...
gi::cstring base::AppLaunchContextBase::get_startup_notify_id (gi::CollectionParameter<GList, ::GFile*, gi::transfer_none_t> files) noexcept
{
  typedef char* (*call_wrap_t) (::GAppLaunchContext* context, ::GAppInfo* info, ::GList* files);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_app_launch_context_get_startup_notify_id;
  auto files_w = unwrap (std::move(files), gi::transfer_none);
...
void AppLaunchContextClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.get_display) methods->get_display = (decltype (methods->get_display)) gi::detail::method_wrapper<self, gi::cstring (*) (Gio::AppInfo info, gi::Collection<GList, ::GFile*, gi::transfer_none_t> files), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_display_>;
  if (init_data.get_startup_notify_id) methods->get_startup_notify_id = (decltype (methods->get_startup_notify_id)) gi::detail::method_wrapper<self, gi::cstring (*) (Gio::AppInfo info, gi::Collection<GList, ::GFile*, gi::transfer_none_t> files), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_startup_notify_id_>;
  if (init_data.launch_failed) methods->launch_failed = (decltype (methods->launch_failed)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v startup_notify_id), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::launch_failed_>;
  if (init_data.launch_started) methods->launch_started = (decltype (methods->launch_started)) gi::detail::method_wrapper<self, void (*) (Gio::AppInfo info, GLib::Variant platform_data), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::launch_started_>;
  if (init_data.launched) methods->launched = (decltype (methods->launched)) gi::detail::method_wrapper<self, void (*) (Gio::AppInfo info, GLib::Variant platform_data), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::launched_>;
}
...
// char* /*full,nullable*/ AppLaunchContext::get_startup_notify_id (GAppLaunchContext* context /*none*/, GAppInfo* info /*none,nullable*/, GList* files /*none,nullable*/);
// char* /*full,nullable*/ AppLaunchContext::get_startup_notify_id (::GAppLaunchContext* context /*none*/, ::GAppInfo* info /*none,nullable*/, ::GList* files /*none,nullable*/);
