...
// ::GResource* /*full*/ g_resource_new_from_data (::GBytes* data /*none*/, GError ** error);
static GI_INLINE_DECL gi::result<Gio::Resource> new_from_data (GLib::Bytes_Ref data) noexcept;
...
// char** /*full*/ g_resource_enumerate_children (::GResource* resource /*none*/, const char* path /*none*/, ::GResourceLookupFlags lookup_flags, GError ** error);
GI_INLINE_DECL gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> enumerate_children (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept;
...
// gboolean g_resource_get_info (::GResource* resource /*none*/, const char* path /*none*/, ::GResourceLookupFlags lookup_flags, gsize* size, guint32* flags, GError ** error);
GI_INLINE_DECL gi::result<bool> get_info (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags, gsize * size, guint32 * flags) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gsize, guint32>> get_info (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept;
...
// ::GBytes* /*full*/ g_resource_lookup_data (::GResource* resource /*none*/, const char* path /*none*/, ::GResourceLookupFlags lookup_flags, GError ** error);
GI_INLINE_DECL gi::result<GLib::Bytes> lookup_data (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept;
...
// ::GInputStream* /*full*/ g_resource_open_stream (::GResource* resource /*none*/, const char* path /*none*/, ::GResourceLookupFlags lookup_flags, GError ** error);
GI_INLINE_DECL gi::result<Gio::InputStream> open_stream (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::Resource> load (const gi::cstring_v filename) noexcept;
