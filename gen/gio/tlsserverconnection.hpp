...
static GI_INLINE_DECL gi::result<Gio::TlsServerConnection> new_ (Gio::IOStream base_io_stream, Gio::TlsCertificate certificate) noexcept;
static GI_INLINE_DECL gi::result<Gio::TlsServerConnection> new_ (Gio::IOStream base_io_stream) noexcept;
