...
gi::result<Gio::SettingsSchemaSource> base::SettingsSchemaSourceBase::new_from_directory (const gi::cstring_v directory, Gio::SettingsSchemaSource_Ref parent, gboolean trusted) noexcept
{
...
gi::result<Gio::SettingsSchemaSource> base::SettingsSchemaSourceBase::new_from_directory (const gi::cstring_v directory, gboolean trusted) noexcept
{
  typedef ::GSettingsSchemaSource* (*call_wrap_t) (const char* directory, ::GSettingsSchemaSource* parent, gboolean trusted, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) g_settings_schema_source_new_from_directory;
  auto trusted_to_c = trusted;
