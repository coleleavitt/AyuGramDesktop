...
void SettingsBackendClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.get_writable) methods->get_writable = (decltype (methods->get_writable)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v key), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_writable_>;
  if (init_data.read) methods->read = (decltype (methods->read)) gi::detail::method_wrapper<self, GLib::Variant (*) (const gi::cstring_v key, const GLib::VariantType_Ref expected_type, gboolean default_value), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::read_>;
  if (init_data.read_user_value) methods->read_user_value = (decltype (methods->read_user_value)) gi::detail::method_wrapper<self, GLib::Variant (*) (const gi::cstring_v key, const GLib::VariantType_Ref expected_type), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::read_user_value_>;
  if (init_data.reset) methods->reset = (decltype (methods->reset)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v key, void* origin_tag), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::reset_>;
  if (init_data.subscribe) methods->subscribe = (decltype (methods->subscribe)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v name), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::subscribe_>;
  if (init_data.sync) methods->sync = (decltype (methods->sync)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::sync_>;
  if (init_data.unsubscribe) methods->unsubscribe = (decltype (methods->unsubscribe)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v name), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::unsubscribe_>;
  if (init_data.write) methods->write = (decltype (methods->write)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v key, GLib::Variant value, void* origin_tag), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::write_>;
  if (init_data.write_tree) methods->write_tree = (decltype (methods->write_tree)) gi::detail::method_wrapper<self, bool (*) (GLib::Tree_Ref tree, void* origin_tag), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::write_tree_>;
}
