...
// gboolean g_volume_eject_with_operation_finish (::GVolume* volume /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
gi::result<bool> base::VolumeBase::eject_with_operation_finish (Gio::AsyncResult result) noexcept
{
...
// gboolean g_volume_mount_finish (::GVolume* volume /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
gi::result<bool> base::VolumeBase::mount_finish (Gio::AsyncResult result) noexcept
{
  typedef gboolean (*call_wrap_t) (::GVolume* volume, ::GAsyncResult* result, GError ** error);
...
// IGNORE; deprecated
void VolumeIfaceClassImpl::eject_ (::GMountUnmountFlags flags, ::GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) noexcept
{
  if (!get_struct_()->eject) { g_critical ("no method in class struct"); return ; }
  typedef void (*call_wrap_t) (::GVolume*, ::GMountUnmountFlags, ::GCancellable*, GAsyncReadyCallback, gpointer);
...
// gboolean Volume::eject_finish (::GVolume* volume /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
// IGNORE; deprecated
gboolean VolumeIfaceClassImpl::eject_finish_ (::GAsyncResult* result, ::GError **error_)
{
  if (!get_struct_()->eject_finish) { g_critical ("no method in class struct"); return {}; }
  typedef gboolean (*call_wrap_t) (::GVolume*, ::GAsyncResult*, ::GError **error_);
