...
void MenuModelClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.get_item_attribute_value) methods->get_item_attribute_value = (decltype (methods->get_item_attribute_value)) gi::detail::method_wrapper<self, GLib::Variant (*) (gint item_index, const gi::cstring_v attribute, const GLib::VariantType_Ref expected_type), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_item_attribute_value_>;
  if (init_data.get_item_attributes) methods->get_item_attributes = (decltype (methods->get_item_attributes)) gi::detail::method_wrapper<self, void (*) (gint item_index, gi::Collection<GHashTable, std::pair<char*, ::GVariant*>, gi::transfer_full_t> & attributes), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::get_item_attributes_>;
  if (init_data.get_item_link) methods->get_item_link = (decltype (methods->get_item_link)) gi::detail::method_wrapper<self, Gio::MenuModel (*) (gint item_index, const gi::cstring_v link), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_item_link_>;
  if (init_data.get_item_links) methods->get_item_links = (decltype (methods->get_item_links)) gi::detail::method_wrapper<self, void (*) (gint item_index, gi::Collection<GHashTable, std::pair<char*, ::GMenuModel*>, gi::transfer_full_t> & links), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::get_item_links_>;
  if (init_data.get_n_items) methods->get_n_items = (decltype (methods->get_n_items)) gi::detail::method_wrapper<self, gint (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_n_items_>;
  if (init_data.is_mutable) methods->is_mutable = (decltype (methods->is_mutable)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::is_mutable_>;
  if (init_data.iterate_item_attributes) methods->iterate_item_attributes = (decltype (methods->iterate_item_attributes)) gi::detail::method_wrapper<self, Gio::MenuAttributeIter (*) (gint item_index), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::iterate_item_attributes_>;
  if (init_data.iterate_item_links) methods->iterate_item_links = (decltype (methods->iterate_item_links)) gi::detail::method_wrapper<self, Gio::MenuLinkIter (*) (gint item_index), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::iterate_item_links_>;
}
