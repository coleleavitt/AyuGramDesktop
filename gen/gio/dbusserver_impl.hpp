...
gi::result<Gio::DBusServer> base::DBusServerBase::new_sync (const gi::cstring_v address, Gio::DBusServerFlags flags, const gi::cstring_v guid, Gio::DBusAuthObserver observer, Gio::Cancellable cancellable) noexcept
{
...
gi::result<Gio::DBusServer> base::DBusServerBase::new_sync (const gi::cstring_v address, Gio::DBusServerFlags flags, const gi::cstring_v guid) noexcept
{
  typedef ::GDBusServer* (*call_wrap_t) (const char* address, ::GDBusServerFlags flags, const char* guid, ::GDBusAuthObserver* observer, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) g_dbus_server_new_sync;
