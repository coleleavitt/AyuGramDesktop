...
GI_INLINE_DECL gi::result<Gio::InputStream> load (gint size, gi::cstring * type, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::InputStream> load (gint size, gi::cstring * type) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<Gio::InputStream, gi::cstring>> load (gint size, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<Gio::InputStream, gi::cstring>> load (gint size) noexcept;
...
// ::GInputStream* /*full*/ g_loadable_icon_load_finish (::GLoadableIcon* icon /*none*/, ::GAsyncResult* res /*none*/, char** type /*full,out,opt*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::InputStream> load_finish (Gio::AsyncResult res, gi::cstring * type) noexcept;
GI_INLINE_DECL Gio::InputStream load_finish (Gio::AsyncResult res, gi::cstring * type, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<Gio::InputStream, gi::cstring>> load_finish (Gio::AsyncResult res) noexcept;
