...
void TlsBackendInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.get_default_database) methods->get_default_database = (decltype (methods->get_default_database)) gi::detail::method_wrapper<self, Gio::TlsDatabase (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_default_database_>;
  if (init_data.supports_dtls) methods->supports_dtls = (decltype (methods->supports_dtls)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::supports_dtls_>;
  if (init_data.supports_tls) methods->supports_tls = (decltype (methods->supports_tls)) gi::detail::method_wrapper<self, bool (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::supports_tls_>;
}
