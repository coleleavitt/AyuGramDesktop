...
using GI_MEMBER_CHECK_CONFLICT(local_file_add_info) = self;
...
virtual void local_file_add_info_ (const char* filename, guint64 device, ::GFileAttributeMatcher* attribute_matcher, ::GFileInfo* info, ::GCancellable* cancellable, gpointer* extra_data, GDestroyNotify* free_extra_data) noexcept = 0;
...
// void Vfs::local_file_add_info (::GVfs* vfs /*none*/, const char* filename /*none*/, guint64 device, ::GFileAttributeMatcher* attribute_matcher /*none*/, ::GFileInfo* info /*none*/, ::GCancellable* cancellable /*none,nullable*/, void* extra_data, GLib::DestroyNotify::cfunction_type free_extra_data /*none*/);
// SKIP; inconsistent free_extra_data in pointer depth (1 vs 0), inconsistent extra_data in pointer depth (2 vs 1)
GI_INLINE_DECL void local_file_add_info_ (const char* filename, guint64 device, ::GFileAttributeMatcher* attribute_matcher, ::GFileInfo* info, ::GCancellable* cancellable, gpointer* extra_data, GDestroyNotify* free_extra_data) noexcept override;
...
struct VfsClassDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(VfsClass, local_file_add_info)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    ...
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, local_file_add_info),
