...
void DBusObjectManagerIfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.get_interface) methods->get_interface = (decltype (methods->get_interface)) gi::detail::method_wrapper<self, Gio::DBusInterface (*) (const gi::cstring_v object_path, const gi::cstring_v interface_name), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::get_interface_>;
  if (init_data.get_object) methods->get_object = (decltype (methods->get_object)) gi::detail::method_wrapper<self, Gio::DBusObject (*) (const gi::cstring_v object_path), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_object_>;
  if (init_data.get_object_path) methods->get_object_path = (decltype (methods->get_object_path)) gi::detail::method_wrapper<self, gi::cstring_v (*) (), gi::transfer_none_t, std::tuple<>>::wrapper<&self::get_object_path_>;
  if (init_data.get_objects) methods->get_objects = (decltype (methods->get_objects)) gi::detail::method_wrapper<self, gi::Collection<GList, ::GDBusObject*, gi::transfer_full_t> (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::get_objects_>;
  if (init_data.interface_added) methods->interface_added = (decltype (methods->interface_added)) gi::detail::method_wrapper<self, void (*) (Gio::DBusObject object, Gio::DBusInterface interface_), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::interface_added_>;
  if (init_data.interface_removed) methods->interface_removed = (decltype (methods->interface_removed)) gi::detail::method_wrapper<self, void (*) (Gio::DBusObject object, Gio::DBusInterface interface_), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::interface_removed_>;
  if (init_data.object_added) methods->object_added = (decltype (methods->object_added)) gi::detail::method_wrapper<self, void (*) (Gio::DBusObject object), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::object_added_>;
  if (init_data.object_removed) methods->object_removed = (decltype (methods->object_removed)) gi::detail::method_wrapper<self, void (*) (Gio::DBusObject object), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::object_removed_>;
}
