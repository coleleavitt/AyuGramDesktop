...
GI_INLINE_DECL gi::result<Gio::ConverterResult> convert (const guint8 * inbuf, gsize inbuf_size, const guint8 * outbuf, gsize outbuf_size, Gio::ConverterFlags flags, gsize & bytes_read, gsize & bytes_written) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<Gio::ConverterResult, gsize, gsize>> convert (const guint8 * inbuf, gsize inbuf_size, const guint8 * outbuf, gsize outbuf_size, Gio::ConverterFlags flags) noexcept;
...
// ::GBytes* /*full*/ g_converter_convert_bytes (::GConverter* converter /*none*/, ::GBytes* bytes /*none*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::Bytes> convert_bytes (GLib::Bytes_Ref bytes) noexcept;
