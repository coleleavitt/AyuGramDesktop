...
void FilenameCompleterClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.got_completion_data) methods->got_completion_data = (decltype (methods->got_completion_data)) gi::detail::method_wrapper<self, void (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::got_completion_data_>;
}
