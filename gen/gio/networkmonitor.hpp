...
// gboolean g_network_monitor_can_reach (::GNetworkMonitor* monitor /*none*/, ::GSocketConnectable* connectable /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> can_reach (Gio::SocketConnectable connectable, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> can_reach (Gio::SocketConnectable connectable) noexcept;
...
// gboolean g_network_monitor_can_reach_finish (::GNetworkMonitor* monitor /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> can_reach_finish (Gio::AsyncResult result) noexcept;
