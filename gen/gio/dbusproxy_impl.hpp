...
// ::GDBusProxy* /*full*/ g_dbus_proxy_new_finish (::GAsyncResult* res /*none*/, GError ** error);
gi::result<Gio::DBusProxy> base::DBusProxyBase::new_finish (Gio::AsyncResult res) noexcept
{
...
// ::GDBusProxy* /*full*/ g_dbus_proxy_new_for_bus_finish (::GAsyncResult* res /*none*/, GError ** error);
gi::result<Gio::DBusProxy> base::DBusProxyBase::new_for_bus_finish (Gio::AsyncResult res) noexcept
{
  typedef ::GDBusProxy* (*call_wrap_t) (::GAsyncResult* res, GError ** error);
...
gi::result<Gio::DBusProxy> base::DBusProxyBase::new_for_bus_sync (Gio::BusType bus_type, Gio::DBusProxyFlags flags, Gio::DBusInterfaceInfo_Ref info, const gi::cstring_v name, const gi::cstring_v object_path, const gi::cstring_v interface_name, Gio::Cancellable cancellable) noexcept
{
...
gi::result<Gio::DBusProxy> base::DBusProxyBase::new_for_bus_sync (Gio::BusType bus_type, Gio::DBusProxyFlags flags, const gi::cstring_v name, const gi::cstring_v object_path, const gi::cstring_v interface_name) noexcept
{
  typedef ::GDBusProxy* (*call_wrap_t) (::GBusType bus_type, ::GDBusProxyFlags flags, ::GDBusInterfaceInfo* info, const char* name, const char* object_path, const char* interface_name, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) g_dbus_proxy_new_for_bus_sync;
...
gi::result<Gio::DBusProxy> base::DBusProxyBase::new_sync (Gio::DBusConnection connection, Gio::DBusProxyFlags flags, Gio::DBusInterfaceInfo_Ref info, const gi::cstring_v name, const gi::cstring_v object_path, const gi::cstring_v interface_name, Gio::Cancellable cancellable) noexcept
{
...
gi::result<Gio::DBusProxy> base::DBusProxyBase::new_sync (Gio::DBusConnection connection, Gio::DBusProxyFlags flags, const gi::cstring_v object_path, const gi::cstring_v interface_name) noexcept
{
  typedef ::GDBusProxy* (*call_wrap_t) (::GDBusConnection* connection, ::GDBusProxyFlags flags, ::GDBusInterfaceInfo* info, const char* name, const char* object_path, const char* interface_name, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) g_dbus_proxy_new_sync;
  auto cancellable_to_c = nullptr;
...
// ::GVariant* /*full*/ g_dbus_proxy_call_finish (::GDBusProxy* proxy /*none*/, ::GAsyncResult* res /*none*/, GError ** error);
gi::result<GLib::Variant> base::DBusProxyBase::call_finish (Gio::AsyncResult res) noexcept
{
...
gi::result<GLib::Variant> base::DBusProxyBase::call_sync (const gi::cstring_v method_name, GLib::Variant parameters, Gio::DBusCallFlags flags, gint timeout_msec, Gio::Cancellable cancellable) noexcept
{
...
gi::result<GLib::Variant> base::DBusProxyBase::call_sync (const gi::cstring_v method_name, Gio::DBusCallFlags flags, gint timeout_msec) noexcept
{
  typedef ::GVariant* (*call_wrap_t) (::GDBusProxy* proxy, const char* method_name, ::GVariant* parameters, ::GDBusCallFlags flags, gint timeout_msec, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dbus_proxy_call_sync;
  auto cancellable_to_c = nullptr;
...
// ::GVariant* /*full*/ g_dbus_proxy_call_with_unix_fd_list_finish (::GDBusProxy* proxy /*none*/, ::GUnixFDList** out_fd_list /*full,out,opt,nullable*/, ::GAsyncResult* res /*none*/, GError ** error);
gi::result<GLib::Variant> base::DBusProxyBase::call_with_unix_fd_list_finish (Gio::UnixFDList * out_fd_list, Gio::AsyncResult res) noexcept
{
...
gi::result<std::tuple<GLib::Variant, Gio::UnixFDList>> base::DBusProxyBase::call_with_unix_fd_list_finish (Gio::AsyncResult res) noexcept
{
  typedef ::GVariant* (*call_wrap_t) (::GDBusProxy* proxy, ::GUnixFDList** out_fd_list, ::GAsyncResult* res, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dbus_proxy_call_with_unix_fd_list_finish;
  auto res_to_c = gi::unwrap (res, gi::transfer_none);
...
gi::result<GLib::Variant> base::DBusProxyBase::call_with_unix_fd_list_sync (const gi::cstring_v method_name, GLib::Variant parameters, Gio::DBusCallFlags flags, gint timeout_msec, Gio::UnixFDList fd_list, Gio::UnixFDList * out_fd_list, Gio::Cancellable cancellable) noexcept
{
...
gi::result<GLib::Variant> base::DBusProxyBase::call_with_unix_fd_list_sync (const gi::cstring_v method_name, Gio::DBusCallFlags flags, gint timeout_msec, Gio::UnixFDList * out_fd_list) noexcept
{
  typedef ::GVariant* (*call_wrap_t) (::GDBusProxy* proxy, const char* method_name, ::GVariant* parameters, ::GDBusCallFlags flags, gint timeout_msec, ::GUnixFDList* fd_list, ::GUnixFDList** out_fd_list, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dbus_proxy_call_with_unix_fd_list_sync;
  auto cancellable_to_c = nullptr;
...
gi::result<std::tuple<GLib::Variant, Gio::UnixFDList>> base::DBusProxyBase::call_with_unix_fd_list_sync (const gi::cstring_v method_name, GLib::Variant parameters, Gio::DBusCallFlags flags, gint timeout_msec, Gio::UnixFDList fd_list, Gio::Cancellable cancellable) noexcept
{
  typedef ::GVariant* (*call_wrap_t) (::GDBusProxy* proxy, const char* method_name, ::GVariant* parameters, ::GDBusCallFlags flags, gint timeout_msec, ::GUnixFDList* fd_list, ::GUnixFDList** out_fd_list, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dbus_proxy_call_with_unix_fd_list_sync;
  auto cancellable_to_c = gi::unwrap (cancellable, gi::transfer_none);
...
gi::result<std::tuple<GLib::Variant, Gio::UnixFDList>> base::DBusProxyBase::call_with_unix_fd_list_sync (const gi::cstring_v method_name, Gio::DBusCallFlags flags, gint timeout_msec) noexcept
{
  typedef ::GVariant* (*call_wrap_t) (::GDBusProxy* proxy, const char* method_name, ::GVariant* parameters, ::GDBusCallFlags flags, gint timeout_msec, ::GUnixFDList* fd_list, ::GUnixFDList** out_fd_list, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dbus_proxy_call_with_unix_fd_list_sync;
  auto cancellable_to_c = nullptr;
...
void DBusProxyClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.g_properties_changed && factory) methods->g_properties_changed = (decltype (methods->g_properties_changed)) gi::detail::method_wrapper<self, void (*) (::GVariant* changed_properties, const gchar* const* invalidated_properties), std::nullptr_t>::wrapper<&self::g_properties_changed_>;
...
void DBusProxyClass::g_properties_changed_ (::GVariant* changed_properties, const gchar* const* invalidated_properties) noexcept
{
  if (!get_struct_()->g_properties_changed) { g_critical ("no method in class struct"); return ; }
  typedef void (*call_wrap_t) (::GDBusProxy*, ::GVariant*, const gchar* const*);
  call_wrap_t call_wrap_v = (call_wrap_t) get_struct_()->g_properties_changed;
  call_wrap_v (gobj_(), changed_properties, invalidated_properties);
}
