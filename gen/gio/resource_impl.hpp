...
// ::GResource* /*full*/ g_resource_new_from_data (::GBytes* data /*none*/, GError ** error);
gi::result<Gio::Resource> base::ResourceBase::new_from_data (GLib::Bytes_Ref data) noexcept
{
...
// char** /*full*/ g_resource_enumerate_children (::GResource* resource /*none*/, const char* path /*none*/, ::GResourceLookupFlags lookup_flags, GError ** error);
gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> base::ResourceBase::enumerate_children (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept
{
...
// gboolean g_resource_get_info (::GResource* resource /*none*/, const char* path /*none*/, ::GResourceLookupFlags lookup_flags, gsize* size, guint32* flags, GError ** error);
gi::result<bool> base::ResourceBase::get_info (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags, gsize * size, guint32 * flags) noexcept
{
...
gi::result<std::tuple<bool, gsize, guint32>> base::ResourceBase::get_info (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept
{
  typedef gboolean (*call_wrap_t) (::GResource* resource, const char* path, ::GResourceLookupFlags lookup_flags, gsize* size, guint32* flags, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_resource_get_info;
  guint32 flags_o {};
...
// ::GBytes* /*full*/ g_resource_lookup_data (::GResource* resource /*none*/, const char* path /*none*/, ::GResourceLookupFlags lookup_flags, GError ** error);
gi::result<GLib::Bytes> base::ResourceBase::lookup_data (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept
{
...
// ::GInputStream* /*full*/ g_resource_open_stream (::GResource* resource /*none*/, const char* path /*none*/, ::GResourceLookupFlags lookup_flags, GError ** error);
gi::result<Gio::InputStream> base::ResourceBase::open_stream (const gi::cstring_v path, Gio::ResourceLookupFlags lookup_flags) noexcept
{
...
gi::result<Gio::Resource> base::ResourceBase::load (const gi::cstring_v filename) noexcept
{
