...
GI_INLINE_DECL gi::result<gssize> read (guint8 * buffer, gsize count, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> read (guint8 * buffer, gsize count) noexcept;
...
GI_INLINE_DECL gi::result<bool> read_all (guint8 * buffer, gsize count, gsize & bytes_read, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> read_all (guint8 * buffer, gsize count, gsize & bytes_read) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gsize>> read_all (guint8 * buffer, gsize count, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gsize>> read_all (guint8 * buffer, gsize count) noexcept;
...
// gboolean g_input_stream_read_all_finish (::GInputStream* stream /*none*/, ::GAsyncResult* result /*none*/, gsize* bytes_read, GError ** error);
GI_INLINE_DECL gi::result<bool> read_all_finish (Gio::AsyncResult result, gsize & bytes_read) noexcept;
GI_INLINE_DECL bool read_all_finish (Gio::AsyncResult result, gsize & bytes_read, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gsize>> read_all_finish (Gio::AsyncResult result) noexcept;
...
// ::GBytes* /*full*/ g_input_stream_read_bytes (::GInputStream* stream /*none*/, gsize count, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::Bytes> read_bytes (gsize count, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<GLib::Bytes> read_bytes (gsize count) noexcept;
...
// ::GBytes* /*full*/ g_input_stream_read_bytes_finish (::GInputStream* stream /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::Bytes> read_bytes_finish (Gio::AsyncResult result) noexcept;
...
// gssize g_input_stream_read_finish (::GInputStream* stream /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gssize> read_finish (Gio::AsyncResult result) noexcept;
...
// gssize g_input_stream_skip (::GInputStream* stream /*none*/, gsize count, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<gssize> skip (gsize count, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gssize> skip (gsize count) noexcept;
...
// gssize g_input_stream_skip_finish (::GInputStream* stream /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gssize> skip_finish (Gio::AsyncResult result) noexcept;
