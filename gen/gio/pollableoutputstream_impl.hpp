...
gi::result<gssize> base::PollableOutputStreamBase::write_nonblocking (const guint8 * buffer, gsize count, Gio::Cancellable cancellable) noexcept
{
...
gi::result<gssize> base::PollableOutputStreamBase::write_nonblocking (const guint8 * buffer, gsize count) noexcept
{
  typedef gssize (*call_wrap_t) (::GPollableOutputStream* stream, guint8* buffer, gsize count, ::GCancellable* cancellable, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_pollable_output_stream_write_nonblocking;
  auto cancellable_to_c = nullptr;
...
void PollableOutputStreamInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.writev_nonblocking && factory) methods->writev_nonblocking = (decltype (methods->writev_nonblocking)) gi::detail::method_wrapper<self, ::GPollableReturn (*) (const GOutputVector* vectors, gsize n_vectors, gsize* bytes_written, ::GError **error_), std::nullptr_t>::wrapper<&self::writev_nonblocking_>;
}
...
// ::GPollableReturn PollableOutputStream::writev_nonblocking (::GPollableOutputStream* stream /*none*/, const ::GOutputVector** vectors /*none*/, gsize n_vectors, gsize* bytes_written, GError ** error);
// SKIP; vectors in boxed array not supported (depth 1)
::GPollableReturn PollableOutputStreamInterfaceClassImpl::writev_nonblocking_ (const GOutputVector* vectors, gsize n_vectors, gsize* bytes_written, ::GError **error_)
{
  if (!get_struct_()->writev_nonblocking) { g_critical ("no method in class struct"); return {}; }
  typedef ::GPollableReturn (*call_wrap_t) (::GPollableOutputStream*, const GOutputVector*, gsize, gsize*, ::GError **error_);
  call_wrap_t call_wrap_v = (call_wrap_t) get_struct_()->writev_nonblocking;
  auto result_ = call_wrap_v (gobj_(), vectors, n_vectors, bytes_written, error_);
  return result_;
}
