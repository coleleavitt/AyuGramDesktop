...
static GI_INLINE_DECL gi::result<Gio::NetworkAddress> parse (const gi::cstring_v host_and_port, guint16 default_port) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::NetworkAddress> parse_uri (const gi::cstring_v uri, guint16 default_port) noexcept;
