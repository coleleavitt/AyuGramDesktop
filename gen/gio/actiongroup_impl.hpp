...
void ActionGroupInterfaceDef::interface_init (gpointer interface_struct, gpointer factory)
{
  ...
  if (init_data.action_added) methods->action_added = (decltype (methods->action_added)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v action_name), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::action_added_>;
  if (init_data.action_enabled_changed) methods->action_enabled_changed = (decltype (methods->action_enabled_changed)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v action_name, gboolean enabled), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::action_enabled_changed_>;
  if (init_data.action_removed) methods->action_removed = (decltype (methods->action_removed)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v action_name), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::action_removed_>;
  if (init_data.action_state_changed) methods->action_state_changed = (decltype (methods->action_state_changed)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v action_name, GLib::Variant state), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::action_state_changed_>;
  if (init_data.activate_action) methods->activate_action = (decltype (methods->activate_action)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v action_name, GLib::Variant parameter), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::activate_action_>;
  if (init_data.change_action_state) methods->change_action_state = (decltype (methods->change_action_state)) gi::detail::method_wrapper<self, void (*) (const gi::cstring_v action_name, GLib::Variant value), gi::transfer_full_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::change_action_state_>;
  if (init_data.get_action_enabled) methods->get_action_enabled = (decltype (methods->get_action_enabled)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v action_name), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_action_enabled_>;
  if (init_data.get_action_parameter_type) methods->get_action_parameter_type = (decltype (methods->get_action_parameter_type)) gi::detail::method_wrapper<self, GLib::VariantType_Ref (*) (const gi::cstring_v action_name), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_action_parameter_type_>;
  if (init_data.get_action_state) methods->get_action_state = (decltype (methods->get_action_state)) gi::detail::method_wrapper<self, GLib::Variant (*) (const gi::cstring_v action_name), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_action_state_>;
  if (init_data.get_action_state_hint) methods->get_action_state_hint = (decltype (methods->get_action_state_hint)) gi::detail::method_wrapper<self, GLib::Variant (*) (const gi::cstring_v action_name), gi::transfer_full_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_action_state_hint_>;
  if (init_data.get_action_state_type) methods->get_action_state_type = (decltype (methods->get_action_state_type)) gi::detail::method_wrapper<self, GLib::VariantType_Ref (*) (const gi::cstring_v action_name), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::get_action_state_type_>;
  if (init_data.has_action) methods->has_action = (decltype (methods->has_action)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v action_name), gi::transfer_none_t, std::tuple<gi::transfer_none_t>>::wrapper<&self::has_action_>;
  if (init_data.list_actions) methods->list_actions = (decltype (methods->list_actions)) gi::detail::method_wrapper<self, gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> (*) (), gi::transfer_full_t, std::tuple<>>::wrapper<&self::list_actions_>;
  if (init_data.query_action) methods->query_action = (decltype (methods->query_action)) gi::detail::method_wrapper<self, bool (*) (const gi::cstring_v action_name, bool & enabled, GLib::VariantType_Ref & parameter_type, GLib::VariantType_Ref & state_type, GLib::Variant & state_hint, GLib::Variant & state), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t, gi::transfer_none_t, gi::transfer_none_t, gi::transfer_full_t, gi::transfer_full_t>>::wrapper<&self::query_action_>;
}
