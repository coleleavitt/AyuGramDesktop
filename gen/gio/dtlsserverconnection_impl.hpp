...
gi::result<Gio::DtlsServerConnection> base::DtlsServerConnectionBase::new_ (Gio::DatagramBased base_socket, Gio::TlsCertificate certificate) noexcept
{
...
gi::result<Gio::DtlsServerConnection> base::DtlsServerConnectionBase::new_ (Gio::DatagramBased base_socket) noexcept
{
  typedef ::GDtlsServerConnection* (*call_wrap_t) (::GDatagramBased* base_socket, ::GTlsCertificate* certificate, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dtls_server_connection_new;
