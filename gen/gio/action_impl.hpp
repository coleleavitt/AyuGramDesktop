...
gi::result<bool> base::ActionBase::parse_detailed_name (const gi::cstring_v detailed_name, gi::cstring * action_name, GLib::Variant * target_value) noexcept
{
...
gi::result<std::tuple<bool, gi::cstring, GLib::Variant>> base::ActionBase::parse_detailed_name (const gi::cstring_v detailed_name) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* detailed_name, char** action_name, ::GVariant** target_value, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_action_parse_detailed_name;
  ::GVariant* target_value_o {};
