...
// ::GDBusConnection* /*full*/ g_dbus_connection_new_finish (::GAsyncResult* res /*none*/, GError ** error);
static GI_INLINE_DECL gi::result<Gio::DBusConnection> new_finish (Gio::AsyncResult res) noexcept;
...
// ::GDBusConnection* /*full*/ g_dbus_connection_new_for_address_finish (::GAsyncResult* res /*none*/, GError ** error);
static GI_INLINE_DECL gi::result<Gio::DBusConnection> new_for_address_finish (Gio::AsyncResult res) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::DBusConnection> new_for_address_sync (const gi::cstring_v address, Gio::DBusConnectionFlags flags, Gio::DBusAuthObserver observer, Gio::Cancellable cancellable) noexcept;
static GI_INLINE_DECL gi::result<Gio::DBusConnection> new_for_address_sync (const gi::cstring_v address, Gio::DBusConnectionFlags flags) noexcept;
...
static GI_INLINE_DECL gi::result<Gio::DBusConnection> new_sync (Gio::IOStream stream, const gi::cstring_v guid, Gio::DBusConnectionFlags flags, Gio::DBusAuthObserver observer, Gio::Cancellable cancellable) noexcept;
static GI_INLINE_DECL gi::result<Gio::DBusConnection> new_sync (Gio::IOStream stream, Gio::DBusConnectionFlags flags) noexcept;
...
// ::GVariant* /*full*/ g_dbus_connection_call_finish (::GDBusConnection* connection /*none*/, ::GAsyncResult* res /*none*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::Variant> call_finish (Gio::AsyncResult res) noexcept;
...
GI_INLINE_DECL gi::result<GLib::Variant> call_sync (const gi::cstring_v bus_name, const gi::cstring_v object_path, const gi::cstring_v interface_name, const gi::cstring_v method_name, GLib::Variant parameters, const GLib::VariantType_Ref reply_type, Gio::DBusCallFlags flags, gint timeout_msec, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<GLib::Variant> call_sync (const gi::cstring_v object_path, const gi::cstring_v interface_name, const gi::cstring_v method_name, Gio::DBusCallFlags flags, gint timeout_msec) noexcept;
...
// ::GVariant* /*full*/ g_dbus_connection_call_with_unix_fd_list_finish (::GDBusConnection* connection /*none*/, ::GUnixFDList** out_fd_list /*full,out,opt,nullable*/, ::GAsyncResult* res /*none*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::Variant> call_with_unix_fd_list_finish (Gio::UnixFDList * out_fd_list, Gio::AsyncResult res) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<GLib::Variant, Gio::UnixFDList>> call_with_unix_fd_list_finish (Gio::AsyncResult res) noexcept;
...
GI_INLINE_DECL gi::result<GLib::Variant> call_with_unix_fd_list_sync (const gi::cstring_v bus_name, const gi::cstring_v object_path, const gi::cstring_v interface_name, const gi::cstring_v method_name, GLib::Variant parameters, const GLib::VariantType_Ref reply_type, Gio::DBusCallFlags flags, gint timeout_msec, Gio::UnixFDList fd_list, Gio::UnixFDList * out_fd_list, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<GLib::Variant> call_with_unix_fd_list_sync (const gi::cstring_v object_path, const gi::cstring_v interface_name, const gi::cstring_v method_name, Gio::DBusCallFlags flags, gint timeout_msec, Gio::UnixFDList * out_fd_list) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<GLib::Variant, Gio::UnixFDList>> call_with_unix_fd_list_sync (const gi::cstring_v bus_name, const gi::cstring_v object_path, const gi::cstring_v interface_name, const gi::cstring_v method_name, GLib::Variant parameters, const GLib::VariantType_Ref reply_type, Gio::DBusCallFlags flags, gint timeout_msec, Gio::UnixFDList fd_list, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<GLib::Variant, Gio::UnixFDList>> call_with_unix_fd_list_sync (const gi::cstring_v object_path, const gi::cstring_v interface_name, const gi::cstring_v method_name, Gio::DBusCallFlags flags, gint timeout_msec) noexcept;
...
// gboolean g_dbus_connection_close_finish (::GDBusConnection* connection /*none*/, ::GAsyncResult* res /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> close_finish (Gio::AsyncResult res) noexcept;
...
// gboolean g_dbus_connection_close_sync (::GDBusConnection* connection /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> close_sync (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> close_sync () noexcept;
...
GI_INLINE_DECL gi::result<bool> emit_signal (const gi::cstring_v destination_bus_name, const gi::cstring_v object_path, const gi::cstring_v interface_name, const gi::cstring_v signal_name, GLib::Variant parameters) noexcept;
GI_INLINE_DECL gi::result<bool> emit_signal (const gi::cstring_v object_path, const gi::cstring_v interface_name, const gi::cstring_v signal_name) noexcept;
...
GI_INLINE_DECL gi::result<guint> export_action_group (const gi::cstring_v object_path, Gio::ActionGroup action_group) noexcept;
...
GI_INLINE_DECL gi::result<guint> export_menu_model (const gi::cstring_v object_path, Gio::MenuModel menu) noexcept;
...
// gboolean g_dbus_connection_flush_finish (::GDBusConnection* connection /*none*/, ::GAsyncResult* res /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> flush_finish (Gio::AsyncResult res) noexcept;
...
// gboolean g_dbus_connection_flush_sync (::GDBusConnection* connection /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> flush_sync (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> flush_sync () noexcept;
...
GI_INLINE_DECL gi::result<guint> register_object_with_closures2 (const gi::cstring_v object_path, Gio::DBusInterfaceInfo_Ref interface_info, GObject::Closure_Ref method_call_closure, GObject::Closure_Ref get_property_closure, GObject::Closure_Ref set_property_closure) noexcept;
GI_INLINE_DECL gi::result<guint> register_object_with_closures2 (const gi::cstring_v object_path, Gio::DBusInterfaceInfo_Ref interface_info) noexcept;
...
GI_INLINE_DECL gi::result<bool> send_message (Gio::DBusMessage message, Gio::DBusSendMessageFlags flags, guint32 * out_serial) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, guint32>> send_message (Gio::DBusMessage message, Gio::DBusSendMessageFlags flags) noexcept;
...
// ::GDBusMessage* /*full*/ g_dbus_connection_send_message_with_reply_finish (::GDBusConnection* connection /*none*/, ::GAsyncResult* res /*none*/, GError ** error);
GI_INLINE_DECL gi::result<Gio::DBusMessage> send_message_with_reply_finish (Gio::AsyncResult res) noexcept;
...
GI_INLINE_DECL gi::result<Gio::DBusMessage> send_message_with_reply_sync (Gio::DBusMessage message, Gio::DBusSendMessageFlags flags, gint timeout_msec, guint32 * out_serial, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<Gio::DBusMessage> send_message_with_reply_sync (Gio::DBusMessage message, Gio::DBusSendMessageFlags flags, gint timeout_msec, guint32 * out_serial) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<Gio::DBusMessage, guint32>> send_message_with_reply_sync (Gio::DBusMessage message, Gio::DBusSendMessageFlags flags, gint timeout_msec, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<Gio::DBusMessage, guint32>> send_message_with_reply_sync (Gio::DBusMessage message, Gio::DBusSendMessageFlags flags, gint timeout_msec) noexcept;
