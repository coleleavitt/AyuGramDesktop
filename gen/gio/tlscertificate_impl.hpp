...
gi::result<Gio::TlsCertificate> base::TlsCertificateBase::new_from_file (const gi::cstring_v file) noexcept
{
...
gi::result<Gio::TlsCertificate> base::TlsCertificateBase::new_from_file_with_password (const gi::cstring_v file, const gi::cstring_v password) noexcept
{
...
gi::result<Gio::TlsCertificate> base::TlsCertificateBase::new_from_files (const gi::cstring_v cert_file, const gi::cstring_v key_file) noexcept
{
...
gi::result<Gio::TlsCertificate> base::TlsCertificateBase::new_from_pem (const gi::cstring_v data, gssize length) noexcept
{
...
gi::result<Gio::TlsCertificate> base::TlsCertificateBase::new_from_pkcs11_uris (const gi::cstring_v pkcs11_uri, const gi::cstring_v private_key_pkcs11_uri) noexcept
{
...
gi::result<Gio::TlsCertificate> base::TlsCertificateBase::new_from_pkcs11_uris (const gi::cstring_v pkcs11_uri) noexcept
{
  typedef ::GTlsCertificate* (*call_wrap_t) (const char* pkcs11_uri, const char* private_key_pkcs11_uri, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) g_tls_certificate_new_from_pkcs11_uris;
...
gi::result<Gio::TlsCertificate> base::TlsCertificateBase::new_from_pkcs12 (const guint8 * data, gsize length, const gi::cstring_v password) noexcept
{
...
gi::result<Gio::TlsCertificate> base::TlsCertificateBase::new_from_pkcs12 (const guint8 * data, gsize length) noexcept
{
  typedef ::GTlsCertificate* (*call_wrap_t) (const guint8* data, gsize length, const char* password, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) g_tls_certificate_new_from_pkcs12;
...
gi::result<gi::Collection<GList, ::GTlsCertificate*, gi::transfer_full_t>> base::TlsCertificateBase::list_new_from_file (const gi::cstring_v file) noexcept
{
