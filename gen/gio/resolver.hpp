...
GI_INLINE_DECL gi::result<gi::cstring> lookup_by_address (Gio::InetAddress address, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gi::cstring> lookup_by_address (Gio::InetAddress address) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> lookup_by_address_finish (Gio::AsyncResult result) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GInetAddress*, gi::transfer_full_t>> lookup_by_name (const gi::cstring_v hostname, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GInetAddress*, gi::transfer_full_t>> lookup_by_name (const gi::cstring_v hostname) noexcept;
...
// ::GList* /*full*/ g_resolver_lookup_by_name_finish (::GResolver* resolver /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GInetAddress*, gi::transfer_full_t>> lookup_by_name_finish (Gio::AsyncResult result) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GInetAddress*, gi::transfer_full_t>> lookup_by_name_with_flags (const gi::cstring_v hostname, Gio::ResolverNameLookupFlags flags, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GInetAddress*, gi::transfer_full_t>> lookup_by_name_with_flags (const gi::cstring_v hostname, Gio::ResolverNameLookupFlags flags) noexcept;
...
// ::GList* /*full*/ g_resolver_lookup_by_name_with_flags_finish (::GResolver* resolver /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GInetAddress*, gi::transfer_full_t>> lookup_by_name_with_flags_finish (Gio::AsyncResult result) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GVariant*, gi::transfer_full_t>> lookup_records (const gi::cstring_v rrname, Gio::ResolverRecordType record_type, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GVariant*, gi::transfer_full_t>> lookup_records (const gi::cstring_v rrname, Gio::ResolverRecordType record_type) noexcept;
...
// ::GList* /*full*/ g_resolver_lookup_records_finish (::GResolver* resolver /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GVariant*, gi::transfer_full_t>> lookup_records_finish (Gio::AsyncResult result) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GSrvTarget*, gi::transfer_full_t>> lookup_service (const gi::cstring_v service, const gi::cstring_v protocol, const gi::cstring_v domain, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GSrvTarget*, gi::transfer_full_t>> lookup_service (const gi::cstring_v service, const gi::cstring_v protocol, const gi::cstring_v domain) noexcept;
...
// ::GList* /*full*/ g_resolver_lookup_service_finish (::GResolver* resolver /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<gi::Collection<GList, ::GSrvTarget*, gi::transfer_full_t>> lookup_service_finish (Gio::AsyncResult result) noexcept;
