...
void MenuLinkIterClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.get_next) methods->get_next = (decltype (methods->get_next)) gi::detail::method_wrapper<self, bool (*) (gi::cstring_v & out_link, Gio::MenuModel & value), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_full_t>>::wrapper<&self::get_next_>;
}
