...
void DBusObjectSkeletonClassDef::class_init (gpointer class_struct, gpointer factory)
{
  ...
  if (init_data.authorize_method) methods->authorize_method = (decltype (methods->authorize_method)) gi::detail::method_wrapper<self, bool (*) (Gio::DBusInterfaceSkeleton interface_, Gio::DBusMethodInvocation invocation), gi::transfer_none_t, std::tuple<gi::transfer_none_t, gi::transfer_none_t>>::wrapper<&self::authorize_method_>;
}
