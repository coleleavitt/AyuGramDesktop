...
static GI_INLINE_DECL gi::result<Gio::Subprocess> new_ (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, Gio::SubprocessFlags flags) noexcept;
...
// gboolean g_subprocess_communicate (::GSubprocess* subprocess /*none*/, ::GBytes* stdin_buf /*none,nullable*/, ::GCancellable* cancellable /*none,nullable*/, ::GBytes** stdout_buf /*full,out,opt,nullable*/, ::GBytes** stderr_buf /*full,out,opt,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> communicate (GLib::Bytes_Ref stdin_buf, Gio::Cancellable cancellable, GLib::Bytes * stdout_buf, GLib::Bytes * stderr_buf) noexcept;
GI_INLINE_DECL gi::result<bool> communicate (GLib::Bytes * stdout_buf, GLib::Bytes * stderr_buf) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Bytes, GLib::Bytes>> communicate (GLib::Bytes_Ref stdin_buf, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Bytes, GLib::Bytes>> communicate () noexcept;
...
// gboolean g_subprocess_communicate_finish (::GSubprocess* subprocess /*none*/, ::GAsyncResult* result /*none*/, ::GBytes** stdout_buf /*full,out,opt,nullable*/, ::GBytes** stderr_buf /*full,out,opt,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> communicate_finish (Gio::AsyncResult result, GLib::Bytes * stdout_buf, GLib::Bytes * stderr_buf) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Bytes, GLib::Bytes>> communicate_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_subprocess_communicate_utf8 (::GSubprocess* subprocess /*none*/, const char* stdin_buf /*none,nullable*/, ::GCancellable* cancellable /*none,nullable*/, char** stdout_buf /*full,out,opt,nullable*/, char** stderr_buf /*full,out,opt,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> communicate_utf8 (const gi::cstring_v stdin_buf, Gio::Cancellable cancellable, gi::cstring * stdout_buf, gi::cstring * stderr_buf) noexcept;
GI_INLINE_DECL gi::result<bool> communicate_utf8 (gi::cstring * stdout_buf, gi::cstring * stderr_buf) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring, gi::cstring>> communicate_utf8 (const gi::cstring_v stdin_buf, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring, gi::cstring>> communicate_utf8 () noexcept;
...
// gboolean g_subprocess_communicate_utf8_finish (::GSubprocess* subprocess /*none*/, ::GAsyncResult* result /*none*/, char** stdout_buf /*full,out,opt,nullable*/, char** stderr_buf /*full,out,opt,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> communicate_utf8_finish (Gio::AsyncResult result, gi::cstring * stdout_buf, gi::cstring * stderr_buf) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring, gi::cstring>> communicate_utf8_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_subprocess_wait (::GSubprocess* subprocess /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> wait (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> wait () noexcept;
...
// gboolean g_subprocess_wait_check (::GSubprocess* subprocess /*none*/, ::GCancellable* cancellable /*none,nullable*/, GError ** error);
GI_INLINE_DECL gi::result<bool> wait_check (Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<bool> wait_check () noexcept;
...
// gboolean g_subprocess_wait_check_finish (::GSubprocess* subprocess /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> wait_check_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_subprocess_wait_finish (::GSubprocess* subprocess /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> wait_finish (Gio::AsyncResult result) noexcept;
