...
// gboolean g_mount_eject_with_operation_finish (::GMount* mount /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> eject_with_operation_finish (Gio::AsyncResult result) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> guess_content_type_finish (Gio::AsyncResult result) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> guess_content_type_sync (gboolean force_rescan, Gio::Cancellable cancellable) noexcept;
GI_INLINE_DECL gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> guess_content_type_sync (gboolean force_rescan) noexcept;
...
// gboolean g_mount_remount_finish (::GMount* mount /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> remount_finish (Gio::AsyncResult result) noexcept;
...
// gboolean g_mount_unmount_with_operation_finish (::GMount* mount /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
GI_INLINE_DECL gi::result<bool> unmount_with_operation_finish (Gio::AsyncResult result) noexcept;
...
using GI_MEMBER_CHECK_CONFLICT(eject) = self;
using GI_MEMBER_CHECK_CONFLICT(eject_finish) = self;
...
using GI_MEMBER_CHECK_CONFLICT(unmount) = self;
using GI_MEMBER_CHECK_CONFLICT(unmount_finish) = self;
...
// IGNORE; deprecated
virtual void eject_ (::GMountUnmountFlags flags, ::GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) noexcept = 0;

// gboolean Mount::eject_finish (GMount* mount /*none*/, GAsyncResult* result /*none*/, GError ** error);
// gboolean Mount::eject_finish (::GMount* mount /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
// IGNORE; deprecated
virtual gboolean eject_finish_ (::GAsyncResult* result, ::GError **error_) = 0;
...
// IGNORE; deprecated
virtual void unmount_ (::GMountUnmountFlags flags, ::GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) noexcept = 0;

// gboolean Mount::unmount_finish (GMount* mount /*none*/, GAsyncResult* result /*none*/, GError ** error);
// gboolean Mount::unmount_finish (::GMount* mount /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
// IGNORE; deprecated
virtual gboolean unmount_finish_ (::GAsyncResult* result, ::GError **error_) = 0;
...
// void Mount::eject (::GMount* mount /*none*/, ::GMountUnmountFlags flags, ::GCancellable* cancellable /*none,nullable*/, Gio::AsyncReadyCallback::cfunction_type callback /*none,nullable*/, void* user_data);
// IGNORE; deprecated
GI_INLINE_DECL void eject_ (::GMountUnmountFlags flags, ::GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) noexcept override;

// gboolean Mount::eject_finish (GMount* mount /*none*/, GAsyncResult* result /*none*/, GError ** error);
// gboolean Mount::eject_finish (::GMount* mount /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
// IGNORE; deprecated
GI_INLINE_DECL gboolean eject_finish_ (::GAsyncResult* result, ::GError **error_) override;
...
// void Mount::unmount (::GMount* mount /*none*/, ::GMountUnmountFlags flags, ::GCancellable* cancellable /*none,nullable*/, Gio::AsyncReadyCallback::cfunction_type callback /*none,nullable*/, void* user_data);
// IGNORE; deprecated
GI_INLINE_DECL void unmount_ (::GMountUnmountFlags flags, ::GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) noexcept override;

// gboolean Mount::unmount_finish (GMount* mount /*none*/, GAsyncResult* result /*none*/, GError ** error);
// gboolean Mount::unmount_finish (::GMount* mount /*none*/, ::GAsyncResult* result /*none*/, GError ** error);
// IGNORE; deprecated
GI_INLINE_DECL gboolean unmount_finish_ (::GAsyncResult* result, ::GError **error_) override;
...
struct MountIfaceDef::TypeInitData
{
  ...
  GI_MEMBER_DEFINE(MountIfaceClassImpl, eject)
  GI_MEMBER_DEFINE(MountIfaceClassImpl, eject_finish)
  ...
  GI_MEMBER_DEFINE(MountIfaceClassImpl, unmount)
  GI_MEMBER_DEFINE(MountIfaceClassImpl, unmount_finish)
...
constexpr static TypeInitData factory()
{
  ...
  return {
    ...
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, eject),
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, eject_finish),
    ...
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, unmount),
    GI_MEMBER_HAS_DEFINITION(SubClass, DefData, unmount_finish),
