...
// gboolean g_markup_parse_context_end_parse (::GMarkupParseContext* context /*none*/, GError ** error);
gi::result<bool> base::MarkupParseContextBase::end_parse () noexcept
{
...
gi::result<bool> base::MarkupParseContextBase::parse (const gi::cstring_v text, gssize text_len) noexcept
{
