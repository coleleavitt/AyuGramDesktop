...
gi::result<gi::cstring> base::MatchInfoBase::expand_references (const gi::cstring_v string_to_expand) const noexcept
{
...
// gboolean g_match_info_next (::GMatchInfo* match_info /*none*/, GError ** error);
gi::result<bool> base::MatchInfoBase::next () noexcept
{
