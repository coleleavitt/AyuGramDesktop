...
gi::result<GLib::IOChannel> base::IOChannelBase::new_file (const gi::cstring_v filename, const gi::cstring_v mode) noexcept
{
...
// ::GIOStatus g_io_channel_flush (::GIOChannel* channel /*none*/, GError ** error);
gi::result<GLib::IOStatus> base::IOChannelBase::flush () noexcept
{
...
gi::result<GLib::IOStatus> base::IOChannelBase::read_chars (guint8 * buf, gsize count, gsize * bytes_read) noexcept
{
...
gi::result<std::tuple<GLib::IOStatus, gsize>> base::IOChannelBase::read_chars (guint8 * buf, gsize count) noexcept
{
  typedef ::GIOStatus (*call_wrap_t) (::GIOChannel* channel, guint8* buf, gsize count, gsize* bytes_read, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_io_channel_read_chars;
  gsize bytes_read_o {};
...
gi::result<GLib::IOStatus> base::IOChannelBase::read_line (gi::cstring & str_return, gsize * length, gsize * terminator_pos) noexcept
{
...
gi::result<std::tuple<GLib::IOStatus, gi::cstring, gsize, gsize>> base::IOChannelBase::read_line () noexcept
{
  typedef ::GIOStatus (*call_wrap_t) (::GIOChannel* channel, char** str_return, gsize* length, gsize* terminator_pos, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_io_channel_read_line;
  gsize terminator_pos_o {};
...
gi::result<GLib::IOStatus> base::IOChannelBase::read_to_end (gi::Collection<gi::DSpan, guint8, gi::transfer_full_t> & str_return) noexcept
{
...
gi::result<std::tuple<GLib::IOStatus, gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>>> base::IOChannelBase::read_to_end () noexcept
{
  typedef ::GIOStatus (*call_wrap_t) (::GIOChannel* channel, guint8** str_return, gsize* length, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_io_channel_read_to_end;
  typedef guint8 str_return_cpptype;
...
// ::GIOStatus g_io_channel_read_unichar (::GIOChannel* channel /*none*/, gunichar* thechar, GError ** error);
gi::result<GLib::IOStatus> base::IOChannelBase::read_unichar (gunichar & thechar) noexcept
{
...
gi::result<std::tuple<GLib::IOStatus, gunichar>> base::IOChannelBase::read_unichar () noexcept
{
  typedef ::GIOStatus (*call_wrap_t) (::GIOChannel* channel, gunichar* thechar, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_io_channel_read_unichar;
  gunichar thechar_o {};
...
// ::GIOStatus g_io_channel_seek_position (::GIOChannel* channel /*none*/, gint64 offset, ::GSeekType type, GError ** error);
gi::result<GLib::IOStatus> base::IOChannelBase::seek_position (gint64 offset, GLib::SeekType type) noexcept
{
...
gi::result<GLib::IOStatus> base::IOChannelBase::set_encoding (const gi::cstring_v encoding) noexcept
{
...
gi::result<GLib::IOStatus> base::IOChannelBase::set_encoding () noexcept
{
  typedef ::GIOStatus (*call_wrap_t) (::GIOChannel* channel, const char* encoding, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_io_channel_set_encoding;
...
// ::GIOStatus g_io_channel_set_flags (::GIOChannel* channel /*none*/, ::GIOFlags flags, GError ** error);
gi::result<GLib::IOStatus> base::IOChannelBase::set_flags (GLib::IOFlags flags) noexcept
{
...
// ::GIOStatus g_io_channel_shutdown (::GIOChannel* channel /*none*/, gboolean flush, GError ** error);
gi::result<GLib::IOStatus> base::IOChannelBase::shutdown (gboolean flush) noexcept
{
...
// ::GIOStatus g_io_channel_write_unichar (::GIOChannel* channel /*none*/, gunichar thechar, GError ** error);
gi::result<GLib::IOStatus> base::IOChannelBase::write_unichar (gunichar thechar) noexcept
{
  typedef ::GIOStatus (*call_wrap_t) (::GIOChannel* channel, gunichar thechar, GError ** error);
