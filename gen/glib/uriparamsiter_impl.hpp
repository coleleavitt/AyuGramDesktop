...
gi::result<bool> base::UriParamsIterBase::next (gi::cstring * attribute, gi::cstring * value) noexcept
{
...
gi::result<std::tuple<bool, gi::cstring, gi::cstring>> base::UriParamsIterBase::next () noexcept
{
  typedef gboolean (*call_wrap_t) (::GUriParamsIter* iter, char** attribute, char** value, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_uri_params_iter_next;
  char* value_o {};
