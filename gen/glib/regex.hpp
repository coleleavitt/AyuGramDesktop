...
static GI_INLINE_DECL gi::result<GLib::Regex> new_ (const gi::cstring_v pattern, GLib::RegexCompileFlags compile_options, GLib::RegexMatchFlags match_options) noexcept;
...
// gboolean g_regex_match_all_full (const ::GRegex* regex /*none*/, const gchar* string /*none*/, gssize string_len, gint start_position, ::GRegexMatchFlags match_options, ::GMatchInfo** match_info /*full,out,opt*/, GError ** error);
GI_INLINE_DECL gi::result<bool> match_all_full (const gchar * string, gssize string_len, gint start_position, GLib::RegexMatchFlags match_options, GLib::MatchInfo * match_info) const noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::MatchInfo>> match_all_full (const gchar * string, gssize string_len, gint start_position, GLib::RegexMatchFlags match_options) const noexcept;
...
// gboolean g_regex_match_full (const ::GRegex* regex /*none*/, const gchar* string /*none*/, gssize string_len, gint start_position, ::GRegexMatchFlags match_options, ::GMatchInfo** match_info /*full,out,opt*/, GError ** error);
GI_INLINE_DECL gi::result<bool> match_full (const gchar * string, gssize string_len, gint start_position, GLib::RegexMatchFlags match_options, GLib::MatchInfo * match_info) const noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::MatchInfo>> match_full (const gchar * string, gssize string_len, gint start_position, GLib::RegexMatchFlags match_options) const noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> replace (const gchar * string, gssize string_len, gint start_position, const gi::cstring_v replacement, GLib::RegexMatchFlags match_options) const noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> replace_eval (const gchar * string, gssize string_len, gint start_position, GLib::RegexMatchFlags match_options, GLib::RegexEvalCallback eval) const noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> replace_literal (const gchar * string, gssize string_len, gint start_position, const gi::cstring_v replacement, GLib::RegexMatchFlags match_options) const noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>> split_full (const gchar * string, gssize string_len, gint start_position, GLib::RegexMatchFlags match_options, gint max_tokens) const noexcept;
...
static GI_INLINE_DECL gi::result<bool> check_replacement (const gi::cstring_v replacement, bool * has_references) noexcept;
...
static GI_INLINE_DECL gi::result<std::tuple<bool, bool>> check_replacement (const gi::cstring_v replacement) noexcept;
