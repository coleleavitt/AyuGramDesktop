...
gi::result<bool> ascii_string_to_signed (const gi::cstring_v str, guint base, gint64 min, gint64 max, gint64 * out_num) noexcept
{
...
gi::result<std::tuple<bool, gint64>> ascii_string_to_signed (const gi::cstring_v str, guint base, gint64 min, gint64 max) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* str, guint base, gint64 min, gint64 max, gint64* out_num, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_ascii_string_to_signed;
  gint64 out_num_o {};
...
gi::result<bool> ascii_string_to_unsigned (const gi::cstring_v str, guint base, guint64 min, guint64 max, guint64 * out_num) noexcept
{
...
gi::result<std::tuple<bool, guint64>> ascii_string_to_unsigned (const gi::cstring_v str, guint base, guint64 min, guint64 max) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* str, guint base, guint64 min, guint64 max, guint64* out_num, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_ascii_string_to_unsigned;
  guint64 out_num_o {};
...
// void g_clear_error (GError ** error);
gi::result<void> clear_error () noexcept
{
...
// gboolean g_close (gint fd, GError ** error);
gi::result<bool> close (gint fd) noexcept
{
...
gint closefrom (gint lowfd) noexcept
{
  typedef gint (*call_wrap_t) (gint lowfd);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_closefrom;
  auto lowfd_to_c = lowfd;
  auto _temp_ret = call_wrap_v ((gint) (lowfd_to_c));
  return _temp_ret;
}
...
gi::result<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>> convert (const guint8 * str, gssize len, const gi::cstring_v to_codeset, const gi::cstring_v from_codeset, gsize * bytes_read) noexcept
{
...
gi::result<std::tuple<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>, gsize>> convert (const guint8 * str, gssize len, const gi::cstring_v to_codeset, const gi::cstring_v from_codeset) noexcept
{
  typedef guint8* (*call_wrap_t) (const guint8* str, gssize len, const char* to_codeset, const char* from_codeset, gsize* bytes_read, gsize* bytes_written, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_convert;
  gsize bytes_read_o {};
...
gi::result<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>> convert_with_fallback (const guint8 * str, gssize len, const gi::cstring_v to_codeset, const gi::cstring_v from_codeset, const gi::cstring_v fallback, gsize * bytes_read) noexcept
{
...
gi::result<std::tuple<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>, gsize>> convert_with_fallback (const guint8 * str, gssize len, const gi::cstring_v to_codeset, const gi::cstring_v from_codeset, const gi::cstring_v fallback) noexcept
{
  typedef guint8* (*call_wrap_t) (const guint8* str, gssize len, const char* to_codeset, const char* from_codeset, const char* fallback, gsize* bytes_read, gsize* bytes_written, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_convert_with_fallback;
  gsize bytes_read_o {};
...
gint fdwalk_set_cloexec (gint lowfd) noexcept
{
  typedef gint (*call_wrap_t) (gint lowfd);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_fdwalk_set_cloexec;
  auto lowfd_to_c = lowfd;
  auto _temp_ret = call_wrap_v ((gint) (lowfd_to_c));
  return _temp_ret;
}
...
gi::result<bool> file_get_contents (const gi::cstring_v filename, gi::Collection<gi::DSpan, guint8, gi::transfer_full_t> & contents) noexcept
{
...
gi::result<std::tuple<bool, gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>>> file_get_contents (const gi::cstring_v filename) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* filename, guint8** contents, gsize* length, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_file_get_contents;
  typedef guint8 contents_cpptype;
...
gi::result<gint> file_open_tmp (const gi::cstring_v tmpl, gi::cstring & name_used) noexcept
{
...
gi::result<gint> file_open_tmp (gi::cstring & name_used) noexcept
{
  typedef gint (*call_wrap_t) (const char* tmpl, char** name_used, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_file_open_tmp;
  char* name_used_o {};
...
gi::result<std::tuple<gint, gi::cstring>> file_open_tmp (const gi::cstring_v tmpl) noexcept
{
  typedef gint (*call_wrap_t) (const char* tmpl, char** name_used, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_file_open_tmp;
  char* name_used_o {};
...
gi::result<std::tuple<gint, gi::cstring>> file_open_tmp () noexcept
{
  typedef gint (*call_wrap_t) (const char* tmpl, char** name_used, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_file_open_tmp;
  char* name_used_o {};
...
gi::result<gi::cstring> file_read_link (const gi::cstring_v filename) noexcept
{
...
gi::result<bool> file_set_contents (const gi::cstring_v filename, const guint8 * contents, gssize length) noexcept
{
...
gi::result<bool> file_set_contents_full (const gi::cstring_v filename, const guint8 * contents, gssize length, GLib::FileSetContentsFlags flags, gint mode) noexcept
{
...
gi::result<gi::cstring> filename_from_uri (const gi::cstring_v uri, gi::cstring * hostname) noexcept
{
...
gi::result<std::tuple<gi::cstring, gi::cstring>> filename_from_uri (const gi::cstring_v uri) noexcept
{
  typedef char* (*call_wrap_t) (const char* uri, char** hostname, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_filename_from_uri;
  char* hostname_o {};
...
gi::result<gi::cstring> filename_from_utf8 (const gi::cstring_v utf8string, gssize len, gsize * bytes_read, gsize * bytes_written) noexcept
{
...
gi::result<std::tuple<gi::cstring, gsize, gsize>> filename_from_utf8 (const gi::cstring_v utf8string, gssize len) noexcept
{
  typedef char* (*call_wrap_t) (const char* utf8string, gssize len, gsize* bytes_read, gsize* bytes_written, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_filename_from_utf8;
  gsize bytes_written_o {};
...
gi::result<gi::cstring> filename_to_uri (const gi::cstring_v filename, const gi::cstring_v hostname) noexcept
{
...
gi::result<gi::cstring> filename_to_uri (const gi::cstring_v filename) noexcept
{
  typedef char* (*call_wrap_t) (const char* filename, const char* hostname, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_filename_to_uri;
...
gi::result<gi::cstring> filename_to_utf8 (const gi::cstring_v opsysstring, gssize len, gsize * bytes_read, gsize * bytes_written) noexcept
{
...
gi::result<std::tuple<gi::cstring, gsize, gsize>> filename_to_utf8 (const gi::cstring_v opsysstring, gssize len) noexcept
{
  typedef char* (*call_wrap_t) (const char* opsysstring, gssize len, gsize* bytes_read, gsize* bytes_written, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_filename_to_utf8;
  gsize bytes_written_o {};
...
gi::result<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>> locale_from_utf8 (const gi::cstring_v utf8string, gssize len, gsize * bytes_read) noexcept
{
...
gi::result<std::tuple<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>, gsize>> locale_from_utf8 (const gi::cstring_v utf8string, gssize len) noexcept
{
  typedef guint8* (*call_wrap_t) (const char* utf8string, gssize len, gsize* bytes_read, gsize* bytes_written, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_locale_from_utf8;
  gsize bytes_read_o {};
...
gi::result<gi::cstring> locale_to_utf8 (const guint8 * opsysstring, gssize len, gsize * bytes_read, gsize * bytes_written) noexcept
{
...
gi::result<std::tuple<gi::cstring, gsize, gsize>> locale_to_utf8 (const guint8 * opsysstring, gssize len) noexcept
{
  typedef char* (*call_wrap_t) (const guint8* opsysstring, gssize len, gsize* bytes_read, gsize* bytes_written, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_locale_to_utf8;
  gsize bytes_written_o {};
...
gi::result<bool> shell_parse_argv (const gi::cstring_v command_line, gint * argcp, gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> * argvp) noexcept
{
...
gi::result<std::tuple<bool, gint, gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>>> shell_parse_argv (const gi::cstring_v command_line) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* command_line, gint* argcp, char*** argvp, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_shell_parse_argv;
  char** argvp_o {};
...
gi::result<gi::cstring> shell_unquote (const gi::cstring_v quoted_string) noexcept
{
...
gi::result<bool> spawn_async (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, GLib::Pid * child_pid) noexcept
{
...
gi::result<bool> spawn_async (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, GLib::Pid * child_pid) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, char** argv, char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, ::GPid* child_pid, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_async;
  ::GPid child_pid_o {};
...
gi::result<std::tuple<bool, GLib::Pid>> spawn_async (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, char** argv, char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, ::GPid* child_pid, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_async;
  ::GPid child_pid_o {};
...
gi::result<std::tuple<bool, GLib::Pid>> spawn_async (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, char** argv, char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, ::GPid* child_pid, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_async;
  ::GPid child_pid_o {};
...
gi::result<bool> spawn_async_with_fds (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, GLib::Pid * child_pid, gint stdin_fd, gint stdout_fd, gint stderr_fd) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, char** argv, char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, ::GPid* child_pid, gint stdin_fd, gint stdout_fd, gint stderr_fd, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_async_with_fds;
  auto stderr_fd_to_c = stderr_fd;
...
gi::result<std::tuple<bool, GLib::Pid>> spawn_async_with_fds (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gint stdin_fd, gint stdout_fd, gint stderr_fd) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, char** argv, char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, ::GPid* child_pid, gint stdin_fd, gint stdout_fd, gint stderr_fd, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_async_with_fds;
  auto stderr_fd_to_c = stderr_fd;
...
gi::result<std::tuple<bool, GLib::Pid>> spawn_async_with_fds (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gint stdin_fd, gint stdout_fd, gint stderr_fd) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, char** argv, char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, ::GPid* child_pid, gint stdin_fd, gint stdout_fd, gint stderr_fd, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_async_with_fds;
  auto stderr_fd_to_c = stderr_fd;
...
gi::result<std::tuple<bool, GLib::Pid, gint, gint, gint>> spawn_async_with_pipes (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, char** argv, char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, ::GPid* child_pid, gint* standard_input, gint* standard_output, gint* standard_error, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_async_with_pipes;
  gint standard_error_o {};
...
gi::result<std::tuple<bool, GLib::Pid, gint, gint, gint>> spawn_async_with_pipes (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, char** argv, char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, ::GPid* child_pid, gint* standard_input, gint* standard_output, gint* standard_error, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_async_with_pipes;
  gint standard_error_o {};
...
gi::result<std::tuple<bool, GLib::Pid, gint, gint, gint>> spawn_async_with_pipes_and_fds (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gint stdin_fd, gint stdout_fd, gint stderr_fd, const gint * source_fds, const gint * target_fds, gsize n_fds) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, const char** argv, const char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, gint stdin_fd, gint stdout_fd, gint stderr_fd, const gint* source_fds, const gint* target_fds, gsize n_fds, ::GPid* child_pid_out, gint* stdin_pipe_out, gint* stdout_pipe_out, gint* stderr_pipe_out, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_async_with_pipes_and_fds;
  gint stderr_pipe_out_o {};
...
gi::result<std::tuple<bool, GLib::Pid, gint, gint, gint>> spawn_async_with_pipes_and_fds (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gint stdin_fd, gint stdout_fd, gint stderr_fd, const gint * source_fds, const gint * target_fds, gsize n_fds) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, const char** argv, const char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, gint stdin_fd, gint stdout_fd, gint stderr_fd, const gint* source_fds, const gint* target_fds, gsize n_fds, ::GPid* child_pid_out, gint* stdin_pipe_out, gint* stdout_pipe_out, gint* stderr_pipe_out, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_async_with_pipes_and_fds;
  gint stderr_pipe_out_o {};
...
// gboolean g_spawn_check_wait_status (gint wait_status, GError ** error);
gi::result<bool> spawn_check_wait_status (gint wait_status) noexcept
{
...
gi::result<bool> spawn_command_line_async (const gi::cstring_v command_line) noexcept
{
...
gi::result<bool> spawn_command_line_sync (const gi::cstring_v command_line, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t> * standard_output, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t> * standard_error, gint * wait_status) noexcept
{
...
gi::result<std::tuple<bool, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gint>> spawn_command_line_sync (const gi::cstring_v command_line) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* command_line, guint8** standard_output, guint8** standard_error, gint* wait_status, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_command_line_sync;
  gint wait_status_o {};
...
gi::result<std::tuple<bool, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gint>> spawn_sync (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, char** argv, char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, guint8** standard_output, guint8** standard_error, gint* wait_status, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_sync;
  gint wait_status_o {};
...
gi::result<std::tuple<bool, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gint>> spawn_sync (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* working_directory, char** argv, char** envp, ::GSpawnFlags flags, GLib::SpawnChildSetupFunc::cfunction_type child_setup, void* user_data, guint8** standard_output, guint8** standard_error, gint* wait_status, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_spawn_sync;
  gint wait_status_o {};
...
gi::result<gi::cstring> ucs4_to_utf8 (const gunichar * str, glong len, glong * items_read, glong * items_written) noexcept
{
...
gi::result<std::tuple<gi::cstring, glong, glong>> ucs4_to_utf8 (const gunichar * str, glong len) noexcept
{
  typedef char* (*call_wrap_t) (const gunichar* str, glong len, glong* items_read, glong* items_written, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_ucs4_to_utf8;
  glong items_written_o {};
...
gi::result<gpointer> unix_get_passwd_entry (const gi::cstring_v user_name) noexcept
{
...
// gboolean g_unix_open_pipe (gint* fds /*none*/, gint flags, GError ** error);
gi::result<bool> unix_open_pipe (gi::CollectionParameter<gi::FSpan<2>, gint, gi::transfer_none_t> fds, gint flags) noexcept
{
...
// gboolean g_unix_set_fd_nonblocking (gint fd, gboolean nonblock, GError ** error);
gi::result<bool> unix_set_fd_nonblocking (gint fd, gboolean nonblock) noexcept
{
...
gi::result<gi::cstring> utf16_to_utf8 (const guint16 * str, glong len, glong * items_read, glong * items_written) noexcept
{
...
gi::result<std::tuple<gi::cstring, glong, glong>> utf16_to_utf8 (const guint16 * str, glong len) noexcept
{
  typedef char* (*call_wrap_t) (const guint16* str, glong len, glong* items_read, glong* items_written, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_utf16_to_utf8;
  glong items_written_o {};
