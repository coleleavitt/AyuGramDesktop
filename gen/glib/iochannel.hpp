...
static GI_INLINE_DECL gi::result<GLib::IOChannel> new_file (const gi::cstring_v filename, const gi::cstring_v mode) noexcept;
...
// ::GIOStatus g_io_channel_flush (::GIOChannel* channel /*none*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::IOStatus> flush () noexcept;
...
GI_INLINE_DECL gi::result<GLib::IOStatus> read_chars (guint8 * buf, gsize count, gsize * bytes_read) noexcept;
GI_INLINE_DECL GLib::IOStatus read_chars (guint8 * buf, gsize count, gsize * bytes_read, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<GLib::IOStatus, gsize>> read_chars (guint8 * buf, gsize count) noexcept;
...
GI_INLINE_DECL gi::result<GLib::IOStatus> read_line (gi::cstring & str_return, gsize * length, gsize * terminator_pos) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<GLib::IOStatus, gi::cstring, gsize, gsize>> read_line () noexcept;
...
GI_INLINE_DECL gi::result<GLib::IOStatus> read_to_end (gi::Collection<gi::DSpan, guint8, gi::transfer_full_t> & str_return) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<GLib::IOStatus, gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>>> read_to_end () noexcept;
...
// ::GIOStatus g_io_channel_read_unichar (::GIOChannel* channel /*none*/, gunichar* thechar, GError ** error);
GI_INLINE_DECL gi::result<GLib::IOStatus> read_unichar (gunichar & thechar) noexcept;
GI_INLINE_DECL GLib::IOStatus read_unichar (gunichar & thechar, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<GLib::IOStatus, gunichar>> read_unichar () noexcept;
...
// ::GIOStatus g_io_channel_seek_position (::GIOChannel* channel /*none*/, gint64 offset, ::GSeekType type, GError ** error);
GI_INLINE_DECL gi::result<GLib::IOStatus> seek_position (gint64 offset, GLib::SeekType type) noexcept;
...
GI_INLINE_DECL gi::result<GLib::IOStatus> set_encoding (const gi::cstring_v encoding) noexcept;
GI_INLINE_DECL gi::result<GLib::IOStatus> set_encoding () noexcept;
...
// ::GIOStatus g_io_channel_set_flags (::GIOChannel* channel /*none*/, ::GIOFlags flags, GError ** error);
GI_INLINE_DECL gi::result<GLib::IOStatus> set_flags (GLib::IOFlags flags) noexcept;
...
// ::GIOStatus g_io_channel_shutdown (::GIOChannel* channel /*none*/, gboolean flush, GError ** error);
GI_INLINE_DECL gi::result<GLib::IOStatus> shutdown (gboolean flush) noexcept;
...
// ::GIOStatus g_io_channel_write_unichar (::GIOChannel* channel /*none*/, gunichar thechar, GError ** error);
GI_INLINE_DECL gi::result<GLib::IOStatus> write_unichar (gunichar thechar) noexcept;
