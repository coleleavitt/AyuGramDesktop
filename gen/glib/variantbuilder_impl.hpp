...
// void g_variant_builder_init_static (GVariantBuilder* builder /*none*/, const GVariantType* type /*none*/);
// void g_variant_builder_init_static (::GVariantBuilder* builder /*none*/, const ::GVariantType* type /*none*/);
void base::VariantBuilderBase::init_static (const GLib::VariantType_Ref type) noexcept
{
  typedef void (*call_wrap_t) (::GVariantBuilder* builder, const ::GVariantType* type);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_variant_builder_init_static;
  auto type_to_c = gi::unwrap (type, gi::transfer_none);
  call_wrap_v ((::GVariantBuilder*) (gobj_()), (const ::GVariantType*) (type_to_c));
}
