...
GI_INLINE_DECL gi::result<GLib::Uri> parse_relative (const gi::cstring_v uri_ref, GLib::UriFlags flags) noexcept;
...
static GI_INLINE_DECL gi::result<bool> is_valid (const gi::cstring_v uri_string, GLib::UriFlags flags) noexcept;
...
static GI_INLINE_DECL gi::result<GLib::Uri> parse (const gi::cstring_v uri_string, GLib::UriFlags flags) noexcept;
...
static GI_INLINE_DECL gi::result<gi::Collection<GHashTable, std::pair<char*, char*>, gi::transfer_full_t>> parse_params (const gi::cstring_v params, gssize length, const gi::cstring_v separators, GLib::UriParamsFlags flags) noexcept;
...
static GI_INLINE_DECL gi::result<gi::cstring> resolve_relative (const gi::cstring_v base_uri_string, const gi::cstring_v uri_ref, GLib::UriFlags flags) noexcept;
static GI_INLINE_DECL gi::result<gi::cstring> resolve_relative (const gi::cstring_v uri_ref, GLib::UriFlags flags) noexcept;
...
static GI_INLINE_DECL gi::result<bool> split (const gi::cstring_v uri_ref, GLib::UriFlags flags, gi::cstring * scheme, gi::cstring * userinfo, gi::cstring * host, gint * port, gi::cstring * path, gi::cstring * query, gi::cstring * fragment) noexcept;
...
static GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring, gi::cstring, gi::cstring, gint, gi::cstring, gi::cstring, gi::cstring>> split (const gi::cstring_v uri_ref, GLib::UriFlags flags) noexcept;
...
static GI_INLINE_DECL gi::result<bool> split_network (const gi::cstring_v uri_string, GLib::UriFlags flags, gi::cstring * scheme, gi::cstring * host, gint * port) noexcept;
...
static GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring, gi::cstring, gint>> split_network (const gi::cstring_v uri_string, GLib::UriFlags flags) noexcept;
...
static GI_INLINE_DECL gi::result<bool> split_with_user (const gi::cstring_v uri_ref, GLib::UriFlags flags, gi::cstring * scheme, gi::cstring * user, gi::cstring * password, gi::cstring * auth_params, gi::cstring * host, gint * port, gi::cstring * path, gi::cstring * query, gi::cstring * fragment) noexcept;
...
static GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring, gi::cstring, gi::cstring, gi::cstring, gi::cstring, gint, gi::cstring, gi::cstring, gi::cstring>> split_with_user (const gi::cstring_v uri_ref, GLib::UriFlags flags) noexcept;
...
// ::GBytes* /*full*/ g_uri_unescape_bytes (const char* escaped_string /*none*/, gssize length, const char* illegal_characters /*none,nullable*/, GError ** error);
static GI_INLINE_DECL gi::result<GLib::Bytes> unescape_bytes (const gi::cstring_v escaped_string, gssize length, const gi::cstring_v illegal_characters) noexcept;
static GI_INLINE_DECL gi::result<GLib::Bytes> unescape_bytes (const gi::cstring_v escaped_string, gssize length) noexcept;
