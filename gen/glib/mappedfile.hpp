...
static GI_INLINE_DECL gi::result<GLib::MappedFile> new_ (const gi::cstring_v filename, gboolean writable) noexcept;
...
// ::GMappedFile* /*full*/ g_mapped_file_new_from_fd (gint fd, gboolean writable, GError ** error);
static GI_INLINE_DECL gi::result<GLib::MappedFile> new_from_fd (gint fd, gboolean writable) noexcept;
