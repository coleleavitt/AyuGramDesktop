...
static GI_INLINE_DECL gi::result<GLib::Thread> try_new (const gi::cstring_v name, GLib::ThreadFunc func) noexcept;
static GI_INLINE_DECL gi::result<GLib::Thread> try_new (GLib::ThreadFunc func) noexcept;
