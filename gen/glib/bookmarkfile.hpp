...
// ::GDateTime* /*none*/ g_bookmark_file_get_added_date_time (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::DateTime_Ref> get_added_date_time (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<bool> get_application_info (const gi::cstring_v uri, const gi::cstring_v name, gi::cstring * exec, guint * count, GLib::DateTime_Ref * stamp) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring, guint, GLib::DateTime_Ref>> get_application_info (const gi::cstring_v uri, const gi::cstring_v name) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::DSpan, char*, gi::transfer_full_t>> get_applications (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> get_description (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::DSpan, char*, gi::transfer_full_t>> get_groups (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<bool> get_icon (const gi::cstring_v uri, gi::cstring * href, gi::cstring * mime_type) noexcept;
GI_INLINE_DECL bool get_icon (const gi::cstring_v uri, gi::cstring * href, gi::cstring * mime_type, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring, gi::cstring>> get_icon (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<bool> get_is_private (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> get_mime_type (const gi::cstring_v uri) noexcept;
...
// ::GDateTime* /*none*/ g_bookmark_file_get_modified_date_time (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::DateTime_Ref> get_modified_date_time (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> get_title (const gi::cstring_v uri) noexcept;
GI_INLINE_DECL gi::result<gi::cstring> get_title () noexcept;
...
// ::GDateTime* /*none*/ g_bookmark_file_get_visited_date_time (::GBookmarkFile* bookmark /*none*/, const char* uri /*none*/, GError ** error);
GI_INLINE_DECL gi::result<GLib::DateTime_Ref> get_visited_date_time (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<bool> has_application (const gi::cstring_v uri, const gi::cstring_v name) noexcept;
...
GI_INLINE_DECL gi::result<bool> has_group (const gi::cstring_v uri, const gi::cstring_v group) noexcept;
...
GI_INLINE_DECL gi::result<bool> load_from_data (const guint8 * data, gsize length) noexcept;
...
GI_INLINE_DECL gi::result<bool> load_from_data_dirs (const gi::cstring_v file, gi::cstring * full_path) noexcept;
GI_INLINE_DECL bool load_from_data_dirs (const gi::cstring_v file, gi::cstring * full_path, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring>> load_from_data_dirs (const gi::cstring_v file) noexcept;
...
GI_INLINE_DECL gi::result<bool> load_from_file (const gi::cstring_v filename) noexcept;
...
GI_INLINE_DECL gi::result<bool> move_item (const gi::cstring_v old_uri, const gi::cstring_v new_uri) noexcept;
GI_INLINE_DECL gi::result<bool> move_item (const gi::cstring_v old_uri) noexcept;
...
GI_INLINE_DECL gi::result<bool> remove_application (const gi::cstring_v uri, const gi::cstring_v name) noexcept;
...
GI_INLINE_DECL gi::result<bool> remove_group (const gi::cstring_v uri, const gi::cstring_v group) noexcept;
...
GI_INLINE_DECL gi::result<bool> remove_item (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<bool> set_application_info (const gi::cstring_v uri, const gi::cstring_v name, const gi::cstring_v exec, gint count, GLib::DateTime_Ref stamp) noexcept;
GI_INLINE_DECL gi::result<bool> set_application_info (const gi::cstring_v uri, const gi::cstring_v name, const gi::cstring_v exec, gint count) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>> to_data () noexcept;
...
GI_INLINE_DECL gi::result<bool> to_file (const gi::cstring_v filename) noexcept;
