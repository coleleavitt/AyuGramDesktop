...
gi::result<bool> base::ThreadPoolBase::push (void* data) noexcept
{
...
// gboolean g_thread_pool_set_max_threads (::GThreadPool* pool /*none*/, gint max_threads, GError ** error);
gi::result<bool> base::ThreadPoolBase::set_max_threads (gint max_threads) noexcept
{
...
gi::result<GLib::ThreadPool> base::ThreadPoolBase::new_full (GLib::Func func, gint max_threads, gboolean exclusive) noexcept
{
