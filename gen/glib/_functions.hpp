...
GI_INLINE_DECL gi::result<bool> ascii_string_to_signed (const gi::cstring_v str, guint base, gint64 min, gint64 max, gint64 * out_num) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gint64>> ascii_string_to_signed (const gi::cstring_v str, guint base, gint64 min, gint64 max) noexcept;
...
GI_INLINE_DECL gi::result<bool> ascii_string_to_unsigned (const gi::cstring_v str, guint base, guint64 min, guint64 max, guint64 * out_num) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, guint64>> ascii_string_to_unsigned (const gi::cstring_v str, guint base, guint64 min, guint64 max) noexcept;
...
// void g_clear_error (GError ** error);
GI_INLINE_DECL gi::result<void> clear_error () noexcept;
...
// gboolean g_close (gint fd, GError ** error);
GI_INLINE_DECL gi::result<bool> close (gint fd) noexcept;
GI_INLINE_DECL bool close (gint fd, GLib::Error * _error) noexcept;

// int g_closefrom (int lowfd);
// gint g_closefrom (gint lowfd);
GI_INLINE_DECL gint closefrom (gint lowfd) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>> convert (const guint8 * str, gssize len, const gi::cstring_v to_codeset, const gi::cstring_v from_codeset, gsize * bytes_read) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>, gsize>> convert (const guint8 * str, gssize len, const gi::cstring_v to_codeset, const gi::cstring_v from_codeset) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>> convert_with_fallback (const guint8 * str, gssize len, const gi::cstring_v to_codeset, const gi::cstring_v from_codeset, const gi::cstring_v fallback, gsize * bytes_read) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>, gsize>> convert_with_fallback (const guint8 * str, gssize len, const gi::cstring_v to_codeset, const gi::cstring_v from_codeset, const gi::cstring_v fallback) noexcept;
...
// gint g_fdwalk_set_cloexec (gint lowfd);
GI_INLINE_DECL gint fdwalk_set_cloexec (gint lowfd) noexcept;
...
GI_INLINE_DECL gi::result<bool> file_get_contents (const gi::cstring_v filename, gi::Collection<gi::DSpan, guint8, gi::transfer_full_t> & contents) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>>> file_get_contents (const gi::cstring_v filename) noexcept;
...
GI_INLINE_DECL gi::result<gint> file_open_tmp (const gi::cstring_v tmpl, gi::cstring & name_used) noexcept;
GI_INLINE_DECL gi::result<gint> file_open_tmp (gi::cstring & name_used) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<gint, gi::cstring>> file_open_tmp (const gi::cstring_v tmpl) noexcept;
GI_INLINE_DECL gi::result<std::tuple<gint, gi::cstring>> file_open_tmp () noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> file_read_link (const gi::cstring_v filename) noexcept;
...
GI_INLINE_DECL gi::result<bool> file_set_contents (const gi::cstring_v filename, const guint8 * contents, gssize length) noexcept;
...
GI_INLINE_DECL gi::result<bool> file_set_contents_full (const gi::cstring_v filename, const guint8 * contents, gssize length, GLib::FileSetContentsFlags flags, gint mode) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> filename_from_uri (const gi::cstring_v uri, gi::cstring * hostname) noexcept;
GI_INLINE_DECL gi::cstring filename_from_uri (const gi::cstring_v uri, gi::cstring * hostname, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<gi::cstring, gi::cstring>> filename_from_uri (const gi::cstring_v uri) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> filename_from_utf8 (const gi::cstring_v utf8string, gssize len, gsize * bytes_read, gsize * bytes_written) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<gi::cstring, gsize, gsize>> filename_from_utf8 (const gi::cstring_v utf8string, gssize len) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> filename_to_uri (const gi::cstring_v filename, const gi::cstring_v hostname) noexcept;
GI_INLINE_DECL gi::result<gi::cstring> filename_to_uri (const gi::cstring_v filename) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> filename_to_utf8 (const gi::cstring_v opsysstring, gssize len, gsize * bytes_read, gsize * bytes_written) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<gi::cstring, gsize, gsize>> filename_to_utf8 (const gi::cstring_v opsysstring, gssize len) noexcept;
...
GI_INLINE_DECL gi::result<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>> locale_from_utf8 (const gi::cstring_v utf8string, gssize len, gsize * bytes_read) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<gi::Collection<gi::DSpan, guint8, gi::transfer_full_t>, gsize>> locale_from_utf8 (const gi::cstring_v utf8string, gssize len) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> locale_to_utf8 (const guint8 * opsysstring, gssize len, gsize * bytes_read, gsize * bytes_written) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<gi::cstring, gsize, gsize>> locale_to_utf8 (const guint8 * opsysstring, gssize len) noexcept;
...
GI_INLINE_DECL gi::result<bool> shell_parse_argv (const gi::cstring_v command_line, gint * argcp, gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t> * argvp) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gint, gi::Collection<gi::ZTSpan, char*, gi::transfer_full_t>>> shell_parse_argv (const gi::cstring_v command_line) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> shell_unquote (const gi::cstring_v quoted_string) noexcept;
...
GI_INLINE_DECL gi::result<bool> spawn_async (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, GLib::Pid * child_pid) noexcept;
GI_INLINE_DECL gi::result<bool> spawn_async (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, GLib::Pid * child_pid) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Pid>> spawn_async (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Pid>> spawn_async (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept;
...
GI_INLINE_DECL gi::result<bool> spawn_async_with_fds (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, GLib::Pid * child_pid, gint stdin_fd, gint stdout_fd, gint stderr_fd) noexcept;
GI_INLINE_DECL gi::result<bool> spawn_async_with_fds (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, GLib::Pid * child_pid, gint stdin_fd, gint stdout_fd, gint stderr_fd) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Pid>> spawn_async_with_fds (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gint stdin_fd, gint stdout_fd, gint stderr_fd) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Pid>> spawn_async_with_fds (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gint stdin_fd, gint stdout_fd, gint stderr_fd) noexcept;
...
GI_INLINE_DECL gi::result<bool> spawn_async_with_pipes (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, GLib::Pid * child_pid, gint * standard_input, gint * standard_output, gint * standard_error) noexcept;
GI_INLINE_DECL gi::result<bool> spawn_async_with_pipes (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, GLib::Pid * child_pid, gint * standard_input, gint * standard_output, gint * standard_error) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Pid, gint, gint, gint>> spawn_async_with_pipes (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Pid, gint, gint, gint>> spawn_async_with_pipes (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept;
...
GI_INLINE_DECL gi::result<bool> spawn_async_with_pipes_and_fds (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gint stdin_fd, gint stdout_fd, gint stderr_fd, const gint * source_fds, const gint * target_fds, gsize n_fds, GLib::Pid * child_pid_out, gint * stdin_pipe_out, gint * stdout_pipe_out, gint * stderr_pipe_out) noexcept;
GI_INLINE_DECL gi::result<bool> spawn_async_with_pipes_and_fds (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gint stdin_fd, gint stdout_fd, gint stderr_fd, const gint * source_fds, const gint * target_fds, gsize n_fds, GLib::Pid * child_pid_out, gint * stdin_pipe_out, gint * stdout_pipe_out, gint * stderr_pipe_out) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Pid, gint, gint, gint>> spawn_async_with_pipes_and_fds (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gint stdin_fd, gint stdout_fd, gint stderr_fd, const gint * source_fds, const gint * target_fds, gsize n_fds) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, GLib::Pid, gint, gint, gint>> spawn_async_with_pipes_and_fds (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gint stdin_fd, gint stdout_fd, gint stderr_fd, const gint * source_fds, const gint * target_fds, gsize n_fds) noexcept;
...
// gboolean g_spawn_check_wait_status (gint wait_status, GError ** error);
GI_INLINE_DECL gi::result<bool> spawn_check_wait_status (gint wait_status) noexcept;
...
GI_INLINE_DECL gi::result<bool> spawn_command_line_async (const gi::cstring_v command_line) noexcept;
...
GI_INLINE_DECL gi::result<bool> spawn_command_line_sync (const gi::cstring_v command_line, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t> * standard_output, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t> * standard_error, gint * wait_status) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gint>> spawn_command_line_sync (const gi::cstring_v command_line) noexcept;
...
GI_INLINE_DECL gi::result<bool> spawn_sync (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t> * standard_output, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t> * standard_error, gint * wait_status) noexcept;
GI_INLINE_DECL gi::result<bool> spawn_sync (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t> * standard_output, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t> * standard_error, gint * wait_status) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<bool, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gint>> spawn_sync (const gi::cstring_v working_directory, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gi::Collection<gi::ZTSpan, guint8, gi::transfer_full_t>, gint>> spawn_sync (gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> argv, gi::CollectionParameter<gi::ZTSpan, char*, gi::transfer_none_t> envp, GLib::SpawnFlags flags, GLib::SpawnChildSetupFunc child_setup) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> ucs4_to_utf8 (const gunichar * str, glong len, glong * items_read, glong * items_written) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<gi::cstring, glong, glong>> ucs4_to_utf8 (const gunichar * str, glong len) noexcept;
...
GI_INLINE_DECL gi::result<gpointer> unix_get_passwd_entry (const gi::cstring_v user_name) noexcept;
...
// gboolean g_unix_open_pipe (gint* fds /*none*/, gint flags, GError ** error);
GI_INLINE_DECL gi::result<bool> unix_open_pipe (gi::CollectionParameter<gi::FSpan<2>, gint, gi::transfer_none_t> fds, gint flags) noexcept;
...
// gboolean g_unix_set_fd_nonblocking (gint fd, gboolean nonblock, GError ** error);
GI_INLINE_DECL gi::result<bool> unix_set_fd_nonblocking (gint fd, gboolean nonblock) noexcept;
...
GI_INLINE_DECL gi::result<gi::cstring> utf16_to_utf8 (const guint16 * str, glong len, glong * items_read, glong * items_written) noexcept;
...
GI_INLINE_DECL gi::result<std::tuple<gi::cstring, glong, glong>> utf16_to_utf8 (const guint16 * str, glong len) noexcept;
