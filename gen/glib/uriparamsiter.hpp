...
GI_INLINE_DECL gi::result<bool> next (gi::cstring * attribute, gi::cstring * value) noexcept;
GI_INLINE_DECL bool next (gi::cstring * attribute, gi::cstring * value, GLib::Error * _error) noexcept;
GI_INLINE_DECL gi::result<std::tuple<bool, gi::cstring, gi::cstring>> next () noexcept;
