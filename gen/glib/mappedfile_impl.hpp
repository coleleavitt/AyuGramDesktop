...
gi::result<GLib::MappedFile> base::MappedFileBase::new_ (const gi::cstring_v filename, gboolean writable) noexcept
{
...
// ::GMappedFile* /*full*/ g_mapped_file_new_from_fd (gint fd, gboolean writable, GError ** error);
gi::result<GLib::MappedFile> base::MappedFileBase::new_from_fd (gint fd, gboolean writable) noexcept
{
