...
static GI_INLINE_DECL gi::result<GLib::Dir> open (const gi::cstring_v path, guint flags) noexcept;
...
static GI_INLINE_DECL gi::result<gi::cstring> make_tmp (const gi::cstring_v tmpl) noexcept;
static GI_INLINE_DECL gi::result<gi::cstring> make_tmp () noexcept;
