...
GI_INLINE_DECL gi::result<bool> push (void* data) noexcept;
...
// gboolean g_thread_pool_set_max_threads (::GThreadPool* pool /*none*/, gint max_threads, GError ** error);
GI_INLINE_DECL gi::result<bool> set_max_threads (gint max_threads) noexcept;
...
static GI_INLINE_DECL gi::result<GLib::ThreadPool> new_full (GLib::Func func, gint max_threads, gboolean exclusive) noexcept;
