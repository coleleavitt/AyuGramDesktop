...
static GI_INLINE_DECL GLib::Variant new_from_data (const GLib::VariantType_Ref type, const guint8 * data, gsize size, gboolean trusted, GLib::DestroyNotify notify) noexcept;
