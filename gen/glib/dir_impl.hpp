...
gi::result<GLib::Dir> base::DirBase::open (const gi::cstring_v path, guint flags) noexcept
{
...
gi::result<gi::cstring> base::DirBase::make_tmp (const gi::cstring_v tmpl) noexcept
{
...
gi::result<gi::cstring> base::DirBase::make_tmp () noexcept
{
  typedef char* (*call_wrap_t) (const char* tmpl, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dir_make_tmp;
