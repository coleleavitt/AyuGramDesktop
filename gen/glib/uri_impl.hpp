...
gi::result<GLib::Uri> base::UriBase::parse_relative (const gi::cstring_v uri_ref, GLib::UriFlags flags) noexcept
{
...
gi::result<bool> base::UriBase::is_valid (const gi::cstring_v uri_string, GLib::UriFlags flags) noexcept
{
...
gi::result<GLib::Uri> base::UriBase::parse (const gi::cstring_v uri_string, GLib::UriFlags flags) noexcept
{
...
gi::result<gi::Collection<GHashTable, std::pair<char*, char*>, gi::transfer_full_t>> base::UriBase::parse_params (const gi::cstring_v params, gssize length, const gi::cstring_v separators, GLib::UriParamsFlags flags) noexcept
{
...
gi::result<gi::cstring> base::UriBase::resolve_relative (const gi::cstring_v base_uri_string, const gi::cstring_v uri_ref, GLib::UriFlags flags) noexcept
{
...
gi::result<gi::cstring> base::UriBase::resolve_relative (const gi::cstring_v uri_ref, GLib::UriFlags flags) noexcept
{
  typedef char* (*call_wrap_t) (const char* base_uri_string, const char* uri_ref, ::GUriFlags flags, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_uri_resolve_relative;
  auto flags_to_c = gi::unwrap (flags);
...
gi::result<bool> base::UriBase::split (const gi::cstring_v uri_ref, GLib::UriFlags flags, gi::cstring * scheme, gi::cstring * userinfo, gi::cstring * host, gint * port, gi::cstring * path, gi::cstring * query, gi::cstring * fragment) noexcept
{
...
gi::result<std::tuple<bool, gi::cstring, gi::cstring, gi::cstring, gint, gi::cstring, gi::cstring, gi::cstring>> base::UriBase::split (const gi::cstring_v uri_ref, GLib::UriFlags flags) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* uri_ref, ::GUriFlags flags, char** scheme, char** userinfo, char** host, gint* port, char** path, char** query, char** fragment, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_uri_split;
  char* fragment_o {};
...
gi::result<bool> base::UriBase::split_network (const gi::cstring_v uri_string, GLib::UriFlags flags, gi::cstring * scheme, gi::cstring * host, gint * port) noexcept
{
...
gi::result<std::tuple<bool, gi::cstring, gi::cstring, gint>> base::UriBase::split_network (const gi::cstring_v uri_string, GLib::UriFlags flags) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* uri_string, ::GUriFlags flags, char** scheme, char** host, gint* port, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_uri_split_network;
  gint port_o {};
...
gi::result<bool> base::UriBase::split_with_user (const gi::cstring_v uri_ref, GLib::UriFlags flags, gi::cstring * scheme, gi::cstring * user, gi::cstring * password, gi::cstring * auth_params, gi::cstring * host, gint * port, gi::cstring * path, gi::cstring * query, gi::cstring * fragment) noexcept
{
...
gi::result<std::tuple<bool, gi::cstring, gi::cstring, gi::cstring, gi::cstring, gi::cstring, gint, gi::cstring, gi::cstring, gi::cstring>> base::UriBase::split_with_user (const gi::cstring_v uri_ref, GLib::UriFlags flags) noexcept
{
  typedef gboolean (*call_wrap_t) (const char* uri_ref, ::GUriFlags flags, char** scheme, char** user, char** password, char** auth_params, char** host, gint* port, char** path, char** query, char** fragment, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_uri_split_with_user;
  char* fragment_o {};
...
// ::GBytes* /*full*/ g_uri_unescape_bytes (const char* escaped_string /*none*/, gssize length, const char* illegal_characters /*none,nullable*/, GError ** error);
gi::result<GLib::Bytes> base::UriBase::unescape_bytes (const gi::cstring_v escaped_string, gssize length, const gi::cstring_v illegal_characters) noexcept
{
...
gi::result<GLib::Bytes> base::UriBase::unescape_bytes (const gi::cstring_v escaped_string, gssize length) noexcept
{
  typedef ::GBytes* (*call_wrap_t) (const char* escaped_string, gssize length, const char* illegal_characters, GError ** error);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_uri_unescape_bytes;
