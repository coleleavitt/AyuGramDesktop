...
// GClosure* /*none*/ g_cclosure_new (GCallback callback_func /*none*/, gpointer user_data, GClosureNotify destroy_data /*none*/);
// ::GClosure* /*none*/ g_cclosure_new ( callback_func /*none*/, void* user_data,  destroy_data /*none*/);
// IGNORE; not introspectable, destroy_data type  not supported, callback_func type  not supported

// GClosure* /*none*/ g_cclosure_new_object (GCallback callback_func /*none*/, GObject* object /*none*/);
// ::GClosure* /*none*/ g_cclosure_new_object ( callback_func /*none*/, ::GObject* object /*none*/);
// IGNORE; not introspectable, callback_func type  not supported

// GClosure* /*none*/ g_cclosure_new_object_swap (GCallback callback_func /*none*/, GObject* object /*none*/);
// ::GClosure* /*none*/ g_cclosure_new_object_swap ( callback_func /*none*/, ::GObject* object /*none*/);
// IGNORE; not introspectable, callback_func type  not supported

// GClosure* /*none*/ g_cclosure_new_swap (GCallback callback_func /*none*/, gpointer user_data, GClosureNotify destroy_data /*none*/);
// ::GClosure* /*none*/ g_cclosure_new_swap ( callback_func /*none*/, void* user_data,  destroy_data /*none*/);
// IGNORE; not introspectable, destroy_data type  not supported, callback_func type  not supported
