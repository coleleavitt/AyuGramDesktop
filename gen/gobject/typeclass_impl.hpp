...
// gpointer /*none*/ g_type_class_get (GType type);
// ::GTypeClass* /*none*/ g_type_class_get (GType type);
GObject::TypeClass_Ref base::TypeClassBase::get (GType type) noexcept
{
  typedef ::GTypeClass* (*call_wrap_t) (GType type);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_type_class_get;
  auto type_to_c = type;
  auto _temp_ret = call_wrap_v ((GType) (type_to_c));
  return gi::wrap (_temp_ret, gi::transfer_none);
}

// gpointer /*none,nullable*/ g_type_class_peek (GType type);
// ::GTypeClass* /*none,nullable*/ g_type_class_peek (GType type);
...
// gpointer /*none,nullable*/ g_type_class_peek_static (GType type);
// ::GTypeClass* /*none,nullable*/ g_type_class_peek_static (GType type);
